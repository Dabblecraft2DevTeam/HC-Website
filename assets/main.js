        ...
        const copyText = async () => {
            try {
                ...
                timeoutId = setTimeout(() => {
                    ...
                    if (originalAriaLabel) address.setAttribute('aria-label', originalAriaLabel);
                    else address.removeAttribute('aria-label');
                    if (originalTitle) address.setAttribute('title', originalTitle);
                    else address.removeAttribute('title');
                }, 2000);
            } catch (err) {
