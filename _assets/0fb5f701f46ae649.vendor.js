/*! For license information please see 0fb5f701f46ae649.vendor.js.LICENSE.txt */
(globalThis.webpackChunk_canva_web =
  ...
  [98821],
  {
              ...
              if (!this.closed) {
                ...
                if ((0, o.T)(l)) {
                  ...
                  try {
                    ...
                    e = m instanceof s.Z ? c(m.errors) : [m];
                  }
                }
                if ((0, r.c)(h)) {
                  f = -1;
    ...
    37684: (t, e, n) => {
      ...
      function l(t, e, n, o) {
        ...
        "string" == typeof t
          ? ((s = (function (t) {
            ...
            (s.state = e))
          : (void 0 === (s = (0, r.A)({}, t)).pathname && (s.pathname = ""),
            s.search
        ...
        return (
          ...
          o
            ? s.pathname
              ? "/" !== s.pathname.charAt(0) &&
                (s.pathname = (0, i.A)(s.pathname, o.pathname))
      ...
      function g(t) {
        ...
        var e,
          ...
          g = !(-1 === window.navigator.userAgent.indexOf("Trident")),
          b = t,
          E = b.forceRefresh,
          y = void 0 !== E && E,
        ...
        function P(t) {
          ((0, r.A)(j, t),
            (j.length = n.length),
            C.notifyListeners(j.location, j.action));
        }
        function O(t) {
          (function (t) {
            return (
        ...
        function L(t) {
          if (N) ((N = !1), P());
            ...
            C.confirmTransitionTo(t, "POP", T, function (e) {
              e
        ...
        function H(t) {
          1 === (U += t) && 1 === t
            ? (window.addEventListener(p, O),
              g && window.addEventListener(m, I))
            : 0 === U &&
              (window.removeEventListener(p, O),
              g && window.removeEventListener(m, I));
        }
        var k = !1;
        var j = {
          length: n.length,
          ...
          push: function (t, e) {
            var r = "PUSH",
              o = l(t, e, S(), j.location);
            C.confirmTransitionTo(o, r, T, function (t) {
              if (t) {
                var e = B(o),
                  s = o.key,
                  a = o.state;
                if (i)
                  if ((n.pushState({ key: s, state: a }, null, e), y))
                    window.location.href = e;
                  else {
                    var c = F.indexOf(j.location.key),
                      u = F.slice(0, c + 1);
                    (u.push(o.key), (F = u), P({ action: r, location: o }));
                  }
            ...
            C.confirmTransitionTo(o, r, T, function (t) {
              if (t) {
                var e = B(o),
                  ...
                  a = o.state;
                if (i)
                  if ((n.replaceState({ key: s, state: a }, null, e), y))
                    window.location.replace(e);
                  else {
                    var c = F.indexOf(j.location.key);
                    (-1 !== c && (F[c] = o.key), P({ action: r, location: o }));
                  }
    ...
    82321: (t, e, n) => {
      ...
      n.d(e, { we: () => R });
      var i = n(978109),
        o = (n(607768), n(612151), n(821046), n(276089)),
        s = n(589916);
      (n(523546), n(944552));
      const a = { ...(r || (r = n.t(i, 2))) },
        c = a.useInsertionEffect || ((t) => t());
      function u(t) {
        const e = i.useRef(() => {
          0;
        });
      ...
      const l = "ArrowUp",
        ...
        f = "ArrowLeft",
        d = "ArrowRight";
      var p = "undefined" != typeof document ? i.useLayoutEffect : i.useEffect;
      const m = [f, d],
        v = [l, h];
      let g = !1,
        b = 0;
      const E = () =>
        "floating-ui-" + Math.random().toString(36).slice(2, 6) + b++;
      const y =
        a.useId ||
        function () {
          const [t, e] = i.useState(() => (g ? E() : void 0));
          return (
            p(() => {
              null == t && e(E());
            }, []),
      ...
      function w() {
        ...
        return {
          ...
          off(e, n) {
            ...
            t.set(
              e,
              (null == (r = t.get(e)) ? void 0 : r.filter((t) => t !== n)) ||
                [],
            );
          },
        };
      ...
      const T = i.createContext(null),
        ...
        A = () => {
          var t;
          return (null == (t = i.useContext(T)) ? void 0 : t.id) || null;
        },
        x = () => i.useContext(_);
      function R(t) {
        void 0 === t && (t = {});
        const { nodeId: e } = t,
          n = (function (t) {
            const { open: e = !1, onOpenChange: n, elements: r } = t,
              ...
              [a] = i.useState(() => w()),
              c = null != A(),
              [l, h] = i.useState(r.reference),
              f = u((t, e, r) => {
                ((s.current.openEvent = t ? e : void 0),
                  a.emit("openchange", {
                    open: t,
                    event: e,
                    reason: r,
              ...
              d = i.useMemo(() => ({ setPositionReference: h }), []),
              p = i.useMemo(
                () => ({
        ...
        const g = (0, s.we)({
          ...
          b = i.useCallback(
            (t) => {
              const e = (0, o.vq)(t)
                ...
                : t;
              (f(e), g.refs.setReference(e));
            },
            [g.refs],
          ),
          E = i.useCallback(
            (t) => {
              (((0, o.vq)(t) || null === t) && ((m.current = t), l(t)),
          ...
          R = i.useMemo(
            () => ({ ...g, ...r, refs: T, elements: _, nodeId: e }),
            [g, T, _, e, r],
          );
        return (
          p(() => {
            ...
            const t =
              null == v ? void 0 : v.nodesRef.current.find((t) => t.id === e);
            t && (t.context = R);
          }),
          i.useMemo(
            () => ({ ...g, context: R, refs: T, elements: _ }),
            [g, T, _, R],
          )
        );
      }
          ...
          return (
            ...
            (e.prototype._innerSub = function (t) {
              ...
              var n = new s.zA(this),
                r = this.destination;
              (r.add(n),
                (this.innerSubscription = (0, s.tS)(t, n)),
    ...
    129332: (t, e, n) => {
      ...
      var r = n(996643),
        ...
        h = n(721076),
        f = function (t) {
          if (t && "function" == typeof t[h.s]) return (0, s.X)(t);
          if ((0, a.X)(t)) return (0, r.v)(t);
          if ((0, c.y)(t)) return (0, i.F)(t);
          if (t && "function" == typeof t[l.lJ]) return (0, o.S)(t);
          var e = (0, u.G)(t) ? "an invalid object" : "'" + t + "'";
          throw new TypeError(
            "You provided " +
              e +
        ...
        function t(e, n, i, u) {
          ...
          if (
            ...
            (this.resolvedOptions = function () {
              ...
              return {
                locale:
                  (null === (t = h.resolvedLocale) || void 0 === t
                    ? void 0
                    : t.toString()) ||
                  Intl.NumberFormat.supportedLocalesOf(h.locales)[0],
              };
            }),
            ...
            var f = u || {},
              d = (f.formatters, (0, r.Tt)(f, ["formatters"]));
            this.ast = t.__parse(
              e,
              (0, r.Cl)((0, r.Cl)({}, d), { locale: this.resolvedLocale }),
            );
          } else this.ast = e;
    ...
    174762: (t, e, n) => {
      ...
      function o() {
        ...
        return (
          ...
          t.scrollLeft > 0
            ? (r = "default")
            : ((t.scrollLeft = 2), t.scrollLeft < 2 && (r = "negative")),
    ...
    192582: (t, e, n) => {
      ...
      function s(t, e, n) {
        ...
        return t || e || n ? new r.v(t, e, n) : new r.v(o.I);
      }
    },
    192897: (t, e, n) => {
      var r;
      !(function () {
        ...
        function x(t) {
          var e = "normal";
          return (
            "o" === t.a ? (e = "oblique") : "i" === t.a && (e = "italic"),
            e
          );
        }
        function R(t) {
        ...
        function F(t, e, n, r, i, o, s) {
          ((this.v = t),
            ...
            (t = L((t = new T(this.a.c + ",serif", A(this.a))))),
            (this.g.a.style.cssText = t),
            (t = L((t = new T(this.a.c + ",sans-serif", A(this.a))))),
            (this.h.a.style.cssText = t),
            (t = L((t = new T("serif", A(this.a))))),
            (this.j.a.style.cssText = t),
            (t = L((t = new T("sans-serif", A(this.a))))),
        ...
        function H(t, e, n) {
          for (var r in B)
            if (B.hasOwnProperty(r) && e === t.f[B[r]] && n === t.f[B[r]])
              return !0;
          return !1;
        }
        function k(t) {
            ...
            setTimeout(function () {
              ...
              if (0 === n.length && o) C(e.a);
                ...
                for (c = 0; c < n.length; c++) {
                  ...
                  if (
                    (f.g &&
                      d(f.f, [f.a.c("wf", p.c, A(p).toString(), "loading")]),
                    P(f, "fontloading", p),
                    (f = null),
                    null === V)
                  )
                    if (window.FontFace) {
                      ...
                      V = p ? 42 < parseInt(p[1], 10) : !m;
                    } else V = !1;
                  ((f = V
                    ? new M(s(e.g, e), s(e.h, e), e.c, l, e.s, h)
                    : new F(s(e.g, e), s(e.h, e), e.c, l, e.s, t, h)),
                    u.push(f));
                }
        ...
        ((G.prototype.g = function (t) {
          ...
          (e.g &&
            d(
              e.f,
              [e.a.c("wf", t.c, A(t).toString(), "active")],
              [
                e.a.c("wf", t.c, A(t).toString(), "loading"),
                e.a.c("wf", t.c, A(t).toString(), "inactive"),
              ],
            ),
            P(e, "fontactive", t),
            (this.m = !0),
          ...
          (G.prototype.h = function (t) {
            var e = this.a;
            if (e.g) {
              var n = p(e.f, e.a.c("wf", t.c, A(t).toString(), "active")),
                r = [],
                i = [e.a.c("wf", t.c, A(t).toString(), "loading")];
              (n || r.push(e.a.c("wf", t.c, A(t).toString(), "inactive")),
                d(e.f, r, i));
            }
            ...
            ((this.c = new c(this.j, t.context || this.j)),
              ...
              (function (t, e, n) {
                var r = [],
                  i = n.timeout;
                !(function (t) {
                  (t.g && d(t.f, [t.a.c("wf", "loading")]), P(t, "loading"));
                })(e);
                r = (function (t, e, n) {
                  var r,
                    i = [];
          ...
          (Y.prototype.load = function (t) {
            var e,
              ...
              s = new g();
            for (e = 0, n = r.length; e < n; e++) m(this.c, r[e], b(s));
            var a = [];
            for (e = 0, n = i.length; e < n; e++)
              if ((r = i[e].split(":"))[1])
                for (var c = r[1].split(","), u = 0; u < c.length; u += 1)
                  a.push(new T(r[0], c[u]));
              else a.push(new T(r[0]));
            E(s, function () {
              t(a, o);
            });
          }));
        ...
        ((nt.prototype.load = function (t) {
          ...
          (!(function (t) {
            for (var e = t.f.length, n = 0; n < e; n++) {
                  ...
                  for (
                    ...
                    if ((l = a[u]).match(/^[\w-]+$/))
                      if (null == (h = et.exec(l.toLowerCase()))) l = "";
                        ...
                        if (
                          ((l = null == (l = h[2]) || "" == l ? "n" : tt[l]),
                          null == (h = h[1]) || "" == h)
                        )
                          h = "4";
                        else var h = Q[h] || (isNaN(h) ? "4" : h.substr(0, 1));
                        l = [l, h].join("");
                      }
                    else l = "";
                    l && s.push(l);
              ...
              for (
                t.c[i] || ((r = J[i]) && (t.c[i] = r)), r = 0;
                r < o.length;
                r += 1
              )
                t.a.push(new T(i, o[r]));
            }
          })(o),
            m(
              n,
    ...
    202239: (t, e, n) => {
      ...
      function a(t) {
        return function (e) {
          return 0 === t ? (0, s.I)() : e.lift(new c(t));
        };
      }
      var c = (function () {
          function t(t) {
            if (((this.total = t), this.total < 0)) throw new o.k();
          }
          return (
            (t.prototype.call = function (t, e) {
    ...
    276089: (t, e, n) => {
      ...
      function o(t) {
        var e;
        return null ==
          (e = (s(t) ? t.ownerDocument : t.document) || window.document)
          ? void 0
          : e.documentElement;
      }
      function s(t) {
      ...
      function u(t) {
        return (
          ...
          (t instanceof ShadowRoot || t instanceof i(t).ShadowRoot)
        );
      }
      function l(t) {
        const { overflow: e, overflowX: n, overflowY: r, display: i } = v(t);
        return (
      ...
      function y(t, e, n) {
        ...
        const o = E(t),
          s = o === (null == (r = t.ownerDocument) ? void 0 : r.body),
          a = i(o);
        return s
          ? e.concat(
              a,
              a.visualViewport || [],
              l(o) ? o : [],
              a.frameElement && n ? y(a.frameElement) : [],
            )
          : e.concat(o, y(o, [], n));
      }
      n.d(e, {
    ...
    294462: (t, e, n) => {
      ...
      const A = void 0 !== o.ResizeObserver ? o.ResizeObserver : _;
    },
    332386: (t, e, n) => {
      "use strict";
      n.d(e, { i: () => I });
      ...
      try {
        w =
          "a" ===
          (null ===
            (r = P("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
              "a",
            )) || void 0 === r
            ? void 0
            : r[0]);
      ...
      if (w) {
        var O = P("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
        T = function (t, e) {
          var n;
          return (
            (O.lastIndex = e),
            null !== (n = O.exec(t)[1]) && void 0 !== n ? n : ""
          );
        };
      } else
        T = function (t, e) {
        ...
        return (
          ...
          (t.prototype.parseTag = function (t, e) {
            ...
            if (this.bumpIf(">")) {
              ...
              return this.error(o.F.UNCLOSED_TAG, d(n, this.clonePosition()));
            }
            return this.error(o.F.INVALID_TAG, d(n, this.clonePosition()));
          }),
          ...
          (t.prototype.parseLiteral = function (t, e) {
            ...
            return {
              val: { type: s.ZE.literal, value: r, location: c },
              err: null,
            };
          }),
          (t.prototype.tryParseLeftAngleBracket = function () {
            return this.isEOF() ||
              60 !== this.char() ||
              (!this.ignoreTag && (N((t = this.peek() || 0)) || 47 === t))
              ? null
              : (this.bump(), "<");
            var t;
          }),
          ...
          (t.prototype.parseArgument = function (t, e) {
            ...
            if ((this.bump(), this.bumpSpace(), this.isEOF()))
              return this.error(
                o.F.EXPECT_ARGUMENT_CLOSING_BRACE,
                d(n, this.clonePosition()),
              );
            if (125 === this.char())
              return (
                this.bump(),
                this.error(o.F.EMPTY_ARGUMENT, d(n, this.clonePosition()))
              );
            var r = this.parseIdentifierIfPossible().value;
            if (!r)
              return this.error(
                o.F.MALFORMED_ARGUMENT,
                d(n, this.clonePosition()),
              );
          ...
          (t.prototype.parseIdentifierIfPossible = function () {
            ...
            return (
              this.bumpTo(r),
              { value: n, location: d(t, this.clonePosition()) }
            );
          }),
          (t.prototype.parseArgumentOptions = function (t, e, n, r) {
            ...
            switch (h) {
              case "":
                return this.error(o.F.EXPECT_ARGUMENT_TYPE, d(u, f));
              case "number":
              case "date":
              case "time":
                this.bumpSpace();
                ...
                if (this.bumpIf(",")) {
                  ...
                  if (0 === (E = C(A.val)).length)
                    return this.error(
                      o.F.EXPECT_ARGUMENT_STYLE,
                      d(this.clonePosition(), this.clonePosition()),
                    );
                  p = { style: E, styleLocation: d(m, this.clonePosition()) };
                }
                if ((R = this.tryParseArgumentClose(r)).err) return R;
                var v = d(r, this.clonePosition());
                if (p && _(null == p ? void 0 : p.style, "::", 0)) {
                  var g = S(p.style.slice(2));
                  if ("number" === h)
                    return (A = this.parseNumberSkeletonFromString(
                      g,
                      p.styleLocation,
                    )).err
                      ? A
                  ...
                  if (0 === g.length)
                    return this.error(o.F.EXPECT_DATE_TIME_SKELETON, v);
                  var b = g;
                  this.locale && (b = (0, l.d)(g, this.locale));
                  var E = {
                    type: s.rq.dateTime,
                    pattern: b,
                    location: p.styleLocation,
                    parsedOptions: this.shouldParseSkeletons ? (0, c.e)(b) : {},
                  };
                  return {
                    val: {
                      type: "date" === h ? s.ZE.date : s.ZE.time,
                      value: n,
                      location: v,
                      style: E,
                    },
              ...
              case "select":
                ...
                if ((this.bumpSpace(), !this.bumpIf(",")))
                  return this.error(
                    o.F.EXPECT_SELECT_ARGUMENT_OPTIONS,
                    d(y, (0, i.Cl)({}, y)),
                  );
                this.bumpSpace();
                var w = this.parseIdentifierIfPossible(),
                  T = 0;
                if ("select" !== h && "offset" === w.value) {
                  if (!this.bumpIf(":"))
                    return this.error(
                      o.F.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                      d(this.clonePosition(), this.clonePosition()),
                    );
                  var A;
                  if (
                    (this.bumpSpace(),
                    (A = this.tryParseDecimalInteger(
                      o.F.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                      o.F.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE,
                    )).err)
                  )
                    return A;
                  (this.bumpSpace(),
                ...
                var R,
                  P = this.tryParsePluralOrSelectOptions(t, h, e, w);
                if (P.err) return P;
                if ((R = this.tryParseArgumentClose(r)).err) return R;
                var O = d(r, this.clonePosition());
                return "select" === h
                  ? {
                      val: {
                        type: s.ZE.select,
              ...
              default:
                return this.error(o.F.INVALID_ARGUMENT_TYPE, d(u, f));
            }
          }),
            ...
            for (var t = 0, e = this.clonePosition(); !this.isEOF(); ) {
              switch (this.char()) {
                case 39:
                  ...
                  if (!this.bumpUntil("'"))
                    return this.error(
                      o.F.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                      d(n, this.clonePosition()),
                    );
                  this.bump();
                  break;
          ...
          (t.prototype.parseNumberSkeletonFromString = function (t, e) {
            ...
            try {
              ...
              return this.error(o.F.INVALID_NUMBER_SKELETON, e);
            }
            return {
              val: {
                type: s.rq.number,
                tokens: n,
                location: e,
                parsedOptions: this.shouldParseSkeletons ? (0, u.e)(n) : {},
              },
              err: null,
            };
          }),
          (t.prototype.tryParsePluralOrSelectOptions = function (t, e, n, r) {
            for (
              var i, s = !1, a = [], c = new Set(), u = r.value, l = r.location;
              ;
            ) {
              if (0 === u.length) {
                ...
                var f = this.tryParseDecimalInteger(
                  o.F.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                  o.F.INVALID_PLURAL_ARGUMENT_SELECTOR,
                );
                if (f.err) return f;
                ((l = d(h, this.clonePosition())),
                  (u = this.message.slice(h.offset, this.offset())));
              }
              if (c.has(u))
                return this.error(
                  "select" === e
                    ? o.F.DUPLICATE_SELECT_ARGUMENT_SELECTOR
                    : o.F.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
                  l,
                );
              ...
              if (!this.bumpIf("{"))
                return this.error(
                  "select" === e
                    ? o.F.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
                    : o.F.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
                  d(this.clonePosition(), this.clonePosition()),
                );
              var m = this.parseMessage(t + 1, e, n);
              if (m.err) return m;
              var v = this.tryParseArgumentClose(p);
              if (v.err) return v;
              (a.push([
                u,
                { value: m.val, location: d(p, this.clonePosition()) },
              ]),
                c.add(u),
                this.bumpSpace(),
            ...
            return 0 === a.length
              ? this.error(
                  "select" === e
                    ? o.F.EXPECT_SELECT_ARGUMENT_SELECTOR
                    : o.F.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                  d(this.clonePosition(), this.clonePosition()),
                )
              : this.requiresOtherClause && !s
                ? this.error(
                    o.F.MISSING_OTHER_CLAUSE,
                    d(this.clonePosition(), this.clonePosition()),
                  )
                : { val: a, err: null };
          }),
          ...
          (t.prototype.bumpIf = function (t) {
            if (_(this.message, t, this.offset())) {
          ...
          (t.prototype.bumpSpace = function () {
            for (; !this.isEOF() && L(this.char()); ) this.bump();
          }),
          ...
          return (
            ...
            (n.updateStatus = function (t, e) {
              (void 0 === t && (t = !1),
                null !== e
                  ? (this.cancelNextCallback(),
                    e === h ? this.performEnter(t) : this.performExit())
    ...
    374560: (t, e, n) => {
      ...
      function i(t, e, n) {
        ...
        switch (u) {
          case "top":
            p = { x: h, y: i.y - o.height };
            break;
          case "bottom":
            p = { x: h, y: i.y + i.height };
            break;
          case "right":
            p = { x: i.x + i.width, y: f };
            break;
      ...
      async function s(t, e) {
        ...
        const {
          ...
          m = (0, r.nI)(p),
          v = c[d ? ("floating" === f ? "reference" : "floating") : f],
          g = (0, r.B1)(
            await s.getClippingRect({
              element:
                null ==
                  (n = await (null == s.isElement ? void 0 : s.isElement(v))) ||
                n
                  ? v
                  : v.contextElement ||
          ...
          y = ((await (null == s.isElement ? void 0 : s.isElement(E))) &&
            (await (null == s.getScale ? void 0 : s.getScale(E)))) || {
            x: 1,
            y: 1,
          },
          w = (0, r.B1)(
      ...
      const a = (t) => ({
        ...
        async fn(e) {
          const {
            ...
            { element: l, padding: h = 0 } = (0, r._3)(t, e) || {};
          if (null == l) return {};
          const f = (0, r.nI)(h),
            d = { x: n, y: i },
            p = (0, r.Dz)(o),
            ...
            _ = await (null == a.getOffsetParent
              ...
              : a.getOffsetParent(l));
          let A = _ ? _[y] : 0;
          (A && (await (null == a.isElement ? void 0 : a.isElement(_)))) ||
            (A = c.floating[y] || s.floating[m]);
          const x = w / 2 - T / 2,
            R = A / 2 - v[m] / 2 - 1,
            S = (0, r.jk)(f[b], R),
            C = (0, r.jk)(f[E], R),
            ...
            L =
              ...
              null != (0, r.Sg)(o) &&
              I !== N &&
              s.reference[m] / 2 - (I < P ? S : C) - v[m] / 2 < 0,
            M = L ? (I < P ? I - P : I - O) : 0;
          return {
            [p]: d[p] + M,
            data: {
                    ...
                    void 0 !== d || p === r.DD
                      ? (function (t, e, n) {
                          return (
                            t
                              ? [
                                  ...n.filter((e) => (0, r.Sg)(e) === t),
                                  ...n.filter((e) => (0, r.Sg)(e) !== t),
                                ]
                              : n.filter((t) => (0, r.C0)(t) === t)
                          ).filter(
                            (n) =>
                              !t ||
                              (0, r.Sg)(n) === t ||
                      ...
                      : p,
                  b = await s(e, v),
                  E = (null == (n = c.autoPlacement) ? void 0 : n.index) || 0,
                  y = g[E];
                if (null == y) return {};
                const w = (0, r.w7)(
                  y,
                  a,
                  await (null == l.isRTL ? void 0 : l.isRTL(h.floating)),
                );
                if (u !== y) return { reset: { placement: g[0] } };
                const T = [b[(0, r.C0)(y)], b[w[0]], b[w[1]]],
                  _ = [
                    ...((null == (i = c.autoPlacement)
                      ? void 0
                      : i.overflows) || []),
                    { placement: y, overflows: T },
                  ],
                  A = g[E + 1];
                if (A)
                  return {
                    data: { index: E + 1, overflows: _ },
                    reset: { placement: A },
                  };
                const x = _.map((t) => {
          ...
          return (
            void 0 === t && (t = {}),
            {
              ...
              async fn(e) {
                ...
                const E = (0, r.C0)(o),
                  y = (0, r.C0)(u) === u,
                  w = await (null == l.isRTL ? void 0 : l.isRTL(h.floating)),
                  T = p || (y || !g ? [(0, r.bV)(u)] : (0, r.WJ)(u));
                p || "none" === v || T.push(...(0, r.lP)(u, g, v, w));
                const _ = [u, ...T],
                  A = await s(e, b),
                  x = [];
                let R = (null == (i = a.flip) ? void 0 : i.overflows) || [];
                if ((f && x.push(A[E]), d)) {
                  const t = (0, r.w7)(o, c, w);
                  x.push(A[t[0]], A[t[1]]);
                }
                if (
                  ((R = [...R, { placement: o, overflows: x }]),
                  !x.every((t) => t <= 0))
                ) {
                  var S, C;
                  const t =
                      ((null == (S = a.flip) ? void 0 : S.index) || 0) + 1,
                    e = _[t];
                  if (e)
                    return {
                      data: { index: t, overflows: R },
                      reset: { placement: e },
                    };
                  let n =
                    null ==
                    (C = R.filter((t) => t.overflows[0] <= 0).sort(
            ...
            async fn(e) {
              ...
              switch (i) {
                case "referenceHidden": {
                  const t = l(
                    await s(e, { ...o, elementContext: "reference" }),
                    n.reference,
                  );
                  return {
                    data: { referenceHiddenOffsets: t, referenceHidden: h(t) },
                  };
                }
                case "escaped": {
                  const t = l(
                    await s(e, { ...o, altBoundary: !0 }),
                    n.floating,
                  );
                  return { data: { escapedOffsets: t, escaped: h(t) } };
                }
                default:
                  return {};
              }
          ...
          void 0 === t && (t = {}),
          {
            ...
            async fn(e) {
              const {
                ...
                { padding: c = 2, x: u, y: l } = (0, r._3)(t, e),
                h = Array.from(
                  (await (null == s.getClientRects
                    ? void 0
                    : s.getClientRects(i.reference))) || [],
                ),
                f = (function (t) {
                  ...
                  for (let r = 0; r < e.length; r++) {
                    const t = e[r];
                    (!i || t.y - i.y > i.height / 2
                      ? n.push([t])
                      : n[n.length - 1].push(t),
                      (i = t));
                  }
                  return n.map((t) => (0, r.B1)(d(t)));
                })(h),
                p = (0, r.B1)(d(h)),
                m = (0, r.nI)(c);
                  ...
                  getBoundingClientRect: function () {
                    ...
                    if (f.length >= 2) {
                      ...
                      const t = "left" === (0, r.C0)(n),
                        e = (0, r.T9)(...f.map((t) => t.right)),
                        i = (0, r.jk)(...f.map((t) => t.left)),
                        o = f.filter((n) => (t ? n.left === i : n.right === e)),
                        s = o[0].top,
      ...
      const m = function (t) {
          return (
            void 0 === t && (t = 0),
            {
              ...
              async fn(e) {
                var n, i;
                const { x: o, y: s, placement: a, middlewareData: c } = e,
                  u = await (async function (t, e) {
                    const { placement: n, platform: i, elements: o } = t,
                      s = await (null == i.isRTL
                        ? void 0
                        : i.isRTL(o.floating)),
                      a = (0, r.C0)(n),
                      c = (0, r.Sg)(n),
                    ...
                    return (
                      c &&
                        "number" == typeof m &&
                        (p = "end" === c ? -1 * m : m),
                      u ? { x: p * h, y: d * l } : { x: d * l, y: p * h }
                    );
                  })(e, t);
                return a === (null == (n = c.offset) ? void 0 : n.placement) &&
                  null != (i = c.arrow) &&
                  i.alignmentOffset
                  ? {}
                  : { x: o + u.x, y: s + u.y, data: { ...u, placement: a } };
              },
            }
          );
        },
          ...
          return (
            void 0 === t && (t = {}),
            {
              ...
              async fn(e) {
                ...
                const g = u.fn({ ...e, [p]: m, [d]: v });
                return { ...g, data: { x: g.x - n, y: g.y - i } };
              },
            }
          );
        },
              ...
              fn(e) {
                ...
                if (u) {
                  const t = "y" === d ? "height" : "width",
                    e = s.reference[d] - s.floating[t] + g.mainAxis,
                    n = s.reference[d] + s.reference[t] - g.mainAxis;
                  p < e ? (p = e) : p > n && (p = n);
                }
                if (l) {
                  var b, E;
                  const t = "y" === d ? "width" : "height",
                    ...
                    n =
                      s.reference[f] -
                      s.floating[t] +
                      ((e && (null == (b = a.offset) ? void 0 : b[f])) || 0) +
                      (e ? 0 : g.crossAxis),
                    i =
                      s.reference[f] +
                      s.reference[t] +
                      (e ? 0 : (null == (E = a.offset) ? void 0 : E[f]) || 0) -
                      (e ? g.crossAxis : 0);
                  m < n ? (m = n) : m > i && (m = i);
                }
                return { [d]: p, [f]: m };
        ...
        b = function (t) {
          return (
            void 0 === t && (t = {}),
            {
              ...
              options: t,
              async fn(e) {
                const { placement: n, rects: i, platform: o, elements: a } = e,
                  { apply: c = () => {}, ...u } = (0, r._3)(t, e),
                  l = await s(e, u),
                  h = (0, r.C0)(n),
                  f = (0, r.Sg)(n),
                  d = "y" === (0, r.TV)(n),
                ...
                "top" === h || "bottom" === h
                  ? ((v = h),
                    (g =
                      f ===
                      ((await (null == o.isRTL ? void 0 : o.isRTL(a.floating)))
                        ? "start"
                        : "end")
                        ? "left"
                        : "right"))
                  : ((g = h), (v = "end" === f ? "top" : "bottom"));
                const b = m - l.top - l.bottom,
                  E = p - l.left - l.right,
                  y = (0, r.jk)(m - l[v], b),
                  w = (0, r.jk)(p - l[g], E),
                  ...
                  d
                    ? (A =
                        ...
                        2 *
                          (0 !== t || 0 !== e
                            ? t + e
                            : (0, r.T9)(l.left, l.right)))
                    : (_ =
                        m -
                        2 *
                          (0 !== n || 0 !== i
                            ? n + i
                            : (0, r.T9)(l.top, l.bottom)));
                }
                await c({ ...e, availableWidth: A, availableHeight: _ });
          ...
          return (
            ...
            (e.getDerivedStateFromProps = function (t, e) {
              var n = e.children,
                r = e.handleExited;
              return {
                children: e.firstRender ? (0, u.dw)(t, r) : (0, u.qX)(t, n, r),
                firstRender: !1,
              };
            }),
            ...
            (n.render = function () {
              var t = this.props,
                e = t.component,
                n = t.childFactory,
                i = (0, r.A)(t, ["component", "childFactory"]),
              ...
              return (
                ...
                delete i.exit,
                null === e
                  ? a.createElement(c.A.Provider, { value: o }, s)
                  : a.createElement(
                      c.A.Provider,
                      { value: o },
    ...
    447524: (t, e) => {
      ...
      const m = {
          FLOAT: { type: "float", name: "float", length: 1 },
          VEC2: { type: "float", name: "vec2", length: 2 },
          VEC3: { type: "float", name: "vec3", length: 3 },
          VEC4: { type: "float", name: "vec4", length: 4 },
        },
        v = {
          MAT2: { type: "matrix", name: "mat2", length: 4 },
          MAT3: { type: "matrix", name: "mat3", length: 9 },
          MAT4: { type: "matrix", name: "mat4", length: 16 },
        },
        g = {
          INT: { type: "int", name: "int", length: 1 },
          IVEC2: { type: "int", name: "ivec2", length: 2 },
          IVEC3: { type: "int", name: "ivec3", length: 3 },
          IVEC4: { type: "int", name: "ivec4", length: 4 },
          SAMPLER2D: { type: "int", name: "sampler2D", length: 1 },
        },
        b = new Map([
          [5126, m.FLOAT],
          [35664, m.VEC2],
      ...
      const T = {
        ...
        A = { front: 1028, back: 1029, "front and back": 1032 },
        x = { cw: 2304, ccw: 2305 },
        R = { add: 32774, subtract: 32778, "reverse subtract": 32779 },
        S = { source: "one", destination: "zero", equation: "add" };
      const C = {
        never: 512,
        less: 513,
        equal: 514,
      ...
      class P {
        constructor({
          ...
          ((this.primitive = T[t]),
            ...
            (this.indices = r
              ? ((p = r),
                Array.isArray(p) && (p = new Uint16Array(p)),
                d(p) && (p = new w(p)),
                p)
              : void 0),
            (this.count = i),
            ...
            (this.uniforms = s),
            (this.textures = a),
            (this._cullFace = l ? A[l] : void 0),
            (this._frontFace = h ? x[h] : 2305),
            (this.blend = c
              ? (function (t) {
                  var e, n;
                  const r = { ...S, ...(null != (e = t.rgb) ? e : t) },
                    i = { ...S, ...(null != (n = t.alpha) ? n : t) };
                  return {
                    rgb: {
                      source: _[r.source],
                      destination: _[r.destination],
                      equation: R[r.equation],
                    },
                    alpha: {
                      source: _[i.source],
                      destination: _[i.destination],
                      equation: R[i.equation],
                    },
                  };
                })(c)
              : void 0),
            (this.depthTest = u
              ? (function (t) {
                  ...
                  return {
                    ...
                    func: C[null != (n = t.func) ? n : "less"],
                    range: { near: 0, far: 1, ...t.range },
                  };
                })(u)
              : void 0),
            (this.renderTarget = f));
        ...
        get resources() {
          return [
            this.shader,
            ...Object.values(this.attributes).map((t) => t.buffer),
      ...
      function O(t) {
        return (
          Array.isArray(t) && (t = new Float32Array(t)),
          d(t) && (t = new y(t)),
          t
        );
      }
      class I {
        constructor(t) {
          ((this.id = h()),
            (this.resourceType = "shader"),
            (this.vertexSource = t.vertexSource),
            (this.fragmentSource = t.fragmentSource));
        }
      }
      const N = "preserve",
        L = "fixed";
      class M {
        constructor(t) {
          ...
          ((this.id = h()),
            ...
            (this.name = t.name),
            (this.alpha = t.alpha || N),
            (this.anisotropy = null != (e = t.anisotropy) ? e : 0),
            (this.colorFormat = t.colorFormat || "rgba"));
        }
        get width() {
      ...
      class F {
        ...
        get colorFormat() {
          ...
          if (4 === t) return "rgba";
          throw new a(
            `Invalid number of color channels for binary texture with ID: ${this.id}. Number of channels must be 1 (R) or 3 (RGB) or 4 (RGBA) but the provided data has ${t} channels.`,
          );
        }
        get numberFormat() {
      ...
      class B {
        constructor(t) {
          ...
          ((this.id = h()),
            (this.resourceType = "texture"),
            (this.textureType = "render"),
            (this.source = null),
            (this.name = t.name),
            (this.alpha = t.alpha || N),
            (this.size = t.size || L),
            (this.width = t.width || ("fixed" === this.size ? 0 : 1)),
            (this.height = t.height || ("fixed" === this.size ? 0 : 1)),
      ...
      function D(t, e) {
        return {
          width:
            "fixed" === t.size ? t.width || e.width : (t.width || 1) * e.width,
          height:
            "fixed" === t.size
              ? t.height || e.height
              : (t.height || 1) * e.height,
      ...
      function U(t, e) {
        if ("u32" === e.dataType && !t.getExtension("OES_element_index_uint"))
          throw new s("UNSIGNED_INT indices are not supported on this device.");
        const n = t.createBuffer(),
          r =
            "buffer" === e.resourceType
              ? t.ARRAY_BUFFER
              : t.ELEMENT_ARRAY_BUFFER;
        return (
          t.bindBuffer(r, n),
          t.bufferData(r, e.source, t.STATIC_DRAW),
          t.bindBuffer(r, null),
          n
        );
      }
      class H {
        ...
        parseData(t) {
          ...
          if (t.flat().length !== e)
            throw new a(
              `Could not set uniform '${this.meta.type} ${this.name}'. Expected data with a length of ${e} but your data has a length of ${t.length}.`,
            );
          return t;
        }
        equals(t) {
      ...
      function k(t, e) {
        const { meta: n, name: r, location: i, data: o } = e,
          s = o.flat();
        if ("int" === n.type)
          switch (n.length) {
            case 1:
            ...
            default:
              throw new a(
                `Could not set the value for uniform '${r}'. Make sure its length is between 1 and 4 (inclusive).`,
              );
          }
          ...
          switch (n.length) {
            case 4:
              t.uniformMatrix2fv(i, !1, s);
              break;
            case 9:
              t.uniformMatrix3fv(i, !1, s);
              break;
            case 16:
              t.uniformMatrix4fv(i, !1, s);
              break;
            default:
              throw new a(
                `Could not set the value for uniform '${r}'. Make sure its length is between 2 and 4 (inclusive).`,
              );
          }
      }
      function j(t, e, n) {
        ...
        if (!o) throw new i("Could not create shader");
        if (
          (t.shaderSource(o, n),
          t.compileShader(o),
          ...
          return o;
        {
          const n = t.getShaderInfoLog(o);
          t.deleteShader(o);
          const i = e === t.VERTEX_SHADER ? "vertex" : "fragment";
          throw new r(`Could not compile ${i} shader. Details: ${n}`);
        }
      }
      function G(t, e) {
        const n = (function (t, e, n) {
          const o = t.createProgram();
          if (!o) throw new i("Could not create program");
          const s = j(t, t.VERTEX_SHADER, e),
            a = j(t, t.FRAGMENT_SHADER, n);
          if (
            (t.attachShader(o, s),
            t.attachShader(o, a),
            t.linkProgram(o),
            ...
            return o;
          throw new r(
            `Could not link program. Details: ${t.getProgramInfoLog(o)}`,
          );
        })(t, e.vertexSource, e.fragmentSource);
        t.useProgram(n);
        const o = t.getProgramParameter(n, t.ACTIVE_ATTRIBUTES),
          s = new Map();
        for (let r = 0; r < o; r++) {
          const e = t.getActiveAttrib(n, r),
            i = e ? t.getAttribLocation(n, e.name) : -1;
          if (!e || -1 === i)
            throw new c(
              `Could not cache attribute. Could not find attribute or location at index ${r}. This is likely a bug with the renderer.`,
            );
          const o = b.get(e.type);
          if (!o)
            throw new a(`Type of attribute '${e.name}' is not supported.`);
          (t.enableVertexAttribArray(i),
            s.set(e.name, { location: i, meta: o }));
        }
        const u = t.getProgramParameter(n, t.ACTIVE_UNIFORMS),
          l = new Map(),
          h = new Map();
        let f = 0;
        for (let r = 0; r < u; r++) {
          const e = t.getActiveUniform(n, r),
            i = e ? t.getUniformLocation(n, e.name) : null;
          if (!e || !i)
            throw new c(
              `Could not cache uniform. Could not find uniform or location at index ${r}. This is likely a bug with the renderer.`,
            );
          const o = e.name.endsWith("[0]") ? e.name.slice(0, -3) : e.name;
        ...
        return (
          t.useProgram(null),
          { program: n, attributes: s, textures: l, uniforms: h }
        );
      }
      let V;
      function X(t, e) {
      ...
      function z(t, e, n) {
        ...
        if (
          ...
          throw new s("No support for floating point textures");
        const o = t.TEXTURE_2D,
          a =
            null != (r = null == n ? void 0 : n.texture)
              ? r
              : t.createTexture();
        if (!a)
          throw new i(
            `Could not create \`WebGLTexture\` for texture: ${(function (t) {
              return JSON.stringify(
                t,
                function (t, e) {
                  if ("resourceType" !== t) {
                    if (e instanceof Uint8Array || e instanceof Float32Array) {
                      const { length: t } = e;
                      return { length: t };
                    }
                    if (
                      ...
                      const { src: t, width: n, height: r } = e;
                      return { src: t, width: n, height: r };
                    }
                    return e;
                  }
                  console.log("stripping resource type", e);
                },
                2,
              );
            })(e)}`,
        ...
        (t.bindTexture(o, a),
          ...
          t.pixelStorei(t.UNPACK_ALIGNMENT, "r" === e.colorFormat ? 1 : 4));
        const c = "f32" === e.numberFormat ? t.FLOAT : t.UNSIGNED_BYTE,
          l = (function (t, e) {
            if ("image" === e.textureType) {
              ...
              if (t instanceof HTMLImageElement)
                return `${t.src}:${t.currentSrc}:${q(e)}`;
              if (t instanceof HTMLVideoElement)
                return `${t.src}:${t.currentSrc}:${t.currentTime}:${q(e)}`;
            } else if ("render" === e.textureType) {
              const { width: n, height: r } = X(t, e);
              return `${n}:${r}`;
            }
          })(t, e),
          h = q(e),
        ...
        if (h && f)
          if ("image" !== e.textureType) {
            const n = e.source,
              { width: r, height: i } = X(t, e);
            t.texImage2D(o, 0, p, r, i, 0, d, c, n);
          } else {
            const n = e.source;
            ((function (t) {
              ...
              (function (t) {
                ...
                return (
                  (e.href = t),
                  !("data:" === e.protocol || "blob:" === e.protocol)
                );
              })(n.src) &&
              !n.crossOrigin &&
              console.warn(
                `Fragl warning: ${n.src} image may come from a different origin but you did not set the crossOrigin attribute.`,
              ),
              t.texImage2D(o, 0, p, d, c, n));
          }
        const m = "f32" === e.numberFormat ? t.NEAREST : t.LINEAR;
        (t.texParameteri(o, t.TEXTURE_MIN_FILTER, m),
          t.texParameteri(o, t.TEXTURE_MAG_FILTER, m),
          t.texParameteri(o, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE),
          t.texParameteri(o, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE));
        const { anisotropy: v } = e,
          g = v
        ...
        return (
          v &&
            g &&
            (null != V ||
              (V = t.getParameter(g.MAX_TEXTURE_MAX_ANISOTROPY_EXT)),
            t.texParameterf(
              t.TEXTURE_2D,
              g.TEXTURE_MAX_ANISOTROPY_EXT,
              Math.min(v, V),
            )),
          t.bindTexture(o, null),
          { texture: a, hash: l }
        );
      }
      function W(t, e) {
      ...
      class Y {
        constructor(t) {
          ((this.gl = t),
            (this.maxAttribs = Number(t.getParameter(t.MAX_VERTEX_ATTRIBS))),
            (this.shouldEnable = Array.from({ length: this.maxAttribs }).fill(
              !1,
            )),
            (this.hasEnabled = Array.from({ length: this.maxAttribs }).fill(
              !1,
            )));
        }
        setEnabled(t, e) {
          if (t < 0) throw new Error(`Attribute index ${t} is out of bounds`);
          if (t >= this.maxAttribs)
            throw new Error(
              `Attribute index ${t} exceeds the maximum number of attributes supported by this device: ${this.maxAttribs}`,
            );
          this.shouldEnable[t] = e;
        }
        update() {
          for (let t = 0; t < this.maxAttribs; t++)
            this.shouldEnable[t] !== this.hasEnabled[t] &&
              ((this.hasEnabled[t] = this.shouldEnable[t]),
              this.shouldEnable[t]
      ...
      class $ {
        constructor(t, e) {
          ((this.gl = t),
            ...
            (this.handleContextLost = (t) => {
              if (this.onContextLost) {
                let e = "No WebGLContextEvent";
                (t &&
                  (e =
                    (null == t ? void 0 : t.statusMessage) ||
                    "No statusMessage"),
                  this.onContextLost(
                    new o(`Error: WebGL context lost - ${e}`),
                  ));
              }
            }),
            (this.env = (null == e ? void 0 : e.env) ||
              window || { devicePixelRatio: 1 }));
          const n = t.canvas;
          if (!n) throw new o("Unexpected canvas type: " + typeof n);
          ((this.onDispose = null == e ? void 0 : e.onDispose),
            (this.canvas = n));
          const [r, i] = this.canvasSize;
          ((this.canvas.width =
            ((null == e ? void 0 : e.width) || r) * this.env.devicePixelRatio),
            (this.canvas.height =
              ((null == e ? void 0 : e.height) || i) *
            ...
            (this.vertexAttribArrayState = new Y(t)));
        }
        flush() {
          this.gl.flush();
        }
        resize(...t) {
          ...
          this.canvas instanceof HTMLCanvasElement
            ? ([e = this.canvas.clientWidth, n = this.canvas.clientHeight] = t)
            : ([e, n] = t),
            (this.canvas.width = e * this.env.devicePixelRatio),
            (this.canvas.height = n * this.env.devicePixelRatio));
        }
        load(t) {
          const e = this.gl,
          ...
          for (const r of n)
            switch (r.resourceType) {
              case "buffer":
              case "elements":
                this.bufferCache.has(r.id) ||
                  this.bufferCache.set(r.id, U(e, r));
                break;
              case "shader":
                this.shaderCache.has(r.id) ||
                  this.shaderCache.set(r.id, G(e, r));
                break;
              case "texture":
                this.textureCache.has(r.id) ||
                  this.textureCache.set(r.id, z(e, r));
                break;
              default:
                throw new u(r);
            }
        ...
        update(t) {
          ...
          for (const r of n)
            if ("texture" === r.resourceType) {
              ...
              if (!t)
                throw new o(
                  `Could not update texture with ID: '${r.id}'. Did you remember to use load()?`,
                );
        ...
        clear(t, e) {
          ...
          if (e) {
            const t =
              null == (n = this.textureCache.get(e.id)) ? void 0 : n.texture;
            if (!t)
              throw new o(
                `Could not find render target with ID: ${e.id}. Did you remember to use load()?`,
              );
          ...
          (u && r.clearColor(...s),
            ...
            h && r.clearStencil(c));
          const f =
            (u ? r.COLOR_BUFFER_BIT : 0) |
            (l ? r.DEPTH_BUFFER_BIT : 0) |
            (h ? r.STENCIL_BUFFER_BIT : 0);
          r.clear(f);
        }
        render(t) {
          var e, n, r, i, c, u, l;
          const h = this.gl,
            f = Array.isArray(t) ? t : t.renderables;
          for (const d of f) {
            const t = this.shaderCache.get(d.shader.id);
            if (!t)
              throw new o(
                `Could not find shader with ID: ${d.shader.id}. Did you remember to use load()?`,
              );
            if (d.blend) {
              const { rgb: t, alpha: e } = d.blend;
              (h.enable(h.BLEND),
                h.blendFuncSeparate(
                  t.source,
                  t.destination,
                ...
                h.blendEquationSeparate(t.equation, e.equation));
            ...
            if (d.depthTest) {
              ...
              (h.enable(h.DEPTH_TEST),
                h.depthMask(t.mask),
                h.depthFunc(t.func),
                h.depthRange(t.range.near, t.range.far));
            } else h.disable(h.DEPTH_TEST);
            if (
              (d.cullFace
                ? (h.enable(h.CULL_FACE),
                  h.frontFace(d.frontFace),
                  h.cullFace(d.cullFace))
                : h.disable(h.CULL_FACE),
              h.useProgram(t.program),
              d.indices)
            ) {
              const t = this.getBuffer(d.indices);
              h.bindBuffer(h.ELEMENT_ARRAY_BUFFER, t);
            } else h.bindBuffer(h.ELEMENT_ARRAY_BUFFER, null);
            const f = d.instances
              ? h.getExtension("ANGLE_instanced_arrays")
              : null;
            if (d.instances && !f)
              throw new s(
                "Instancing is required but not supported on this device",
              );
            ...
            for (const [
              ...
              const t = d.attributes[s];
              if (!t)
                throw new o(
                  `Could not locate shader attribute ${s} within Renderable's attributes.`,
                );
              const u = p(null != (e = t.type) ? e : t.buffer.dataType),
              ...
              (h.bindBuffer(h.ARRAY_BUFFER, l),
                h.vertexAttribPointer(
                  ...
                  c.length,
                  u,
                  null != (n = t.normalized) && n,
                  null != (r = t.stride) ? r : 0,
                  null != (i = t.offset) ? i : 0,
                ),
                d.instances &&
                  t.divisor &&
                  f.vertexAttribDivisorANGLE(a, t.divisor));
            }
            this.vertexAttribArrayState.update();
            const m = { ...d.uniforms, ...this.commonUniforms };
            for (const [e, n] of t.uniforms.entries()) {
              const t = m[e];
              if (!t)
                throw new a(
                  `Could not find a value for uniform '${e}'. Make sure you provide a value.`,
                );
              n.equals(t) || ((n.data = t), k(h, n));
            }
            for (const [e, n] of t.textures.entries()) {
              (h.activeTexture(h.TEXTURE0 + n.data.flat()[0]),
                h.bindTexture(h.TEXTURE_2D, null));
              const t = d.textures[e];
              if (!t)
                throw new a(
                  `Could not find a texture associated with uniform '${e}'. Make sure you provide a value.`,
                );
              const r =
                null == (c = this.textureCache.get(t.id)) ? void 0 : c.texture;
              if (!r)
                throw new o(
                  `Could not find texture with ID: ${t.id}. Did you remember to use load()?`,
                );
              h.bindTexture(h.TEXTURE_2D, r);
            }
            if (d.renderTarget) {
              const t =
                null == (u = this.textureCache.get(d.renderTarget.id))
                  ? void 0
                  : u.texture;
              if (!t)
                throw new o(
                  `Could not find render target with ID: ${d.renderTarget.id}. Did you remember to use load()?`,
                );
              const { width: e, height: n } = X(h, d.renderTarget);
              (h.bindFramebuffer(h.FRAMEBUFFER, this.fbo),
            ...
            d.instances
              ...
              : d.indices
                ...
                : h.drawArrays(d.primitive, 0, null != (l = d.count) ? l : 0);
          }
        }
        release(t) {
        ...
        readPixels(t) {
          ...
          if (t) {
            const i =
              null == (e = this.textureCache.get(t.id)) ? void 0 : e.texture;
            if (!i)
              throw new o(
                `Could not find render target with ID: ${t.id}. Did you remember to use load()?`,
              );
            ((r = X(n, t)),
              n.bindFramebuffer(n.FRAMEBUFFER, this.fbo),
          ...
          const i = new Uint8Array(r.width * r.height * 4);
          return (
            n.readPixels(0, 0, r.width, r.height, n.RGBA, n.UNSIGNED_BYTE, i),
            new ImageData(new Uint8ClampedArray(i.buffer), r.width, r.height)
          );
        }
        dispose() {
          var t;
          const e = this.gl;
          for (const r of this.bufferCache.keys())
            this.deleteResource(r, "buffer");
          for (const r of this.shaderCache.keys())
            this.deleteResource(r, "shader");
          for (const r of this.textureCache.keys())
            this.deleteResource(r, "texture");
          (this.bufferCache.clear(),
            this.shaderCache.clear(),
            this.textureCache.clear(),
            e.deleteFramebuffer(this.fbo),
          ...
          ((this.canvas.width = this.canvas.height = 0),
            ...
            null == (t = this.onDispose) || t.call(this));
        }
        deleteResource(t, e) {
          var n;
          const r = this.gl;
          switch (e) {
            case "buffer":
            case "elements":
              const i = this.bufferCache.get(t) || null;
              (r.deleteBuffer(i), this.bufferCache.delete(t));
              break;
            case "shader":
              const o = this.shaderCache.get(t);
              (r.deleteProgram((null == o ? void 0 : o.program) || null),
                this.shaderCache.delete(t));
              break;
            case "texture":
              const s =
                null == (n = this.textureCache.get(t)) ? void 0 : n.texture;
        ...
        getBuffer(t) {
          ...
          if (!e)
            throw new o(
              `Could not find buffer with ID: ${t.id}. Did you remember to use load()?`,
            );
          return e;
        }
        get commonUniforms() {
      ...
      const K = "uPrevResult",
        Z = {
          attributes: {
            aPosition: new y(new Float32Array([-1, -1, 3, -1, -1, 3])),
          },
          count: 3,
        },
        J = {
      ...
      function Q(t) {
        return t.replace(
          ...
          (t, e) => `void main() {${e}gl_FragColor.rgb *= gl_FragColor.a;\n}`,
        );
      }
      function tt(t) {
        return (function (t) {
      ...
      const et = [],
        nt = et;
      function rt(t, e, n, r, i = et) {
        const o = i,
          s = o.find(
            (i) =>
              !t.includes(i.texture) &&
              e === i.width &&
              n === i.height &&
              r === i.size,
          );
        ...
        })(`pooled-render-texture-${o.length.toString()}`, e, n, r);
        return (o.push({ texture: a, width: e, height: n, size: r }), a);
      }
      class it {
        constructor(t) {
          ((this.index = 0),
            (this._textures =
              null != t
                ? t
                : [
                    new B({ colorFormat: "rgba", numberFormat: "u8" }),
                    new B({ colorFormat: "rgba", numberFormat: "u8" }),
                  ]));
        }
        get textures() {
        ...
        nextBuffer() {
          return (
            (this.index = (this.index + 1) % this._textures.length),
            this._textures[this.index]
          );
        }
      }
      const ot = class t {
        static createPingpongBuffers({ width: t, height: e, size: n } = {}) {
          const r = rt([], t, e, n),
            i = rt([r], t, e, n);
          return new it([r, i]);
        }
        constructor({
          ...
          this.enableOneTriangleOptimisation =
            null != s ? s : t.enableOneTriangleOptimisation;
          const a = null != i ? i : t.createPingpongBuffers(o),
            { passes: c, uniforms: u } = this.convertShorthands(e, n);
          this.uniforms = u;
          const l = c[c.length - 1];
          ((this.finalPassShaderForCanvas = this.getShader(l, !0)),
            (this.finalPassShaderForRenderTexture = this.getShader(l, !1)));
          const h = this.createRenderTextures(c, a, o);
          this.renderables = this.getRenderables(c, h, a, r, o);
        }
        convertShorthands(t, e) {
          return {
            passes: t.map((t) => ("string" == typeof t ? { fragment: t } : t)),
            uniforms: Object.fromEntries(
              Object.entries(null != e ? e : {}).map(([t, e]) => [t, tt(e)]),
            ),
          };
        }
        ...
        getRenderables(t, e, n, r, i) {
          const o = t.slice(0, -1).map((t) => {
              const i = this.getShader(t, !1),
                o = n.currentBuffer(),
                s = t.output
                  ? this.getRenderTexture(t.output, e)
                  : n.nextBuffer();
              return this.getRenderable(t, i, o, s, e, r);
            }),
            s = i
              ? this.finalPassShaderForRenderTexture
              : this.finalPassShaderForCanvas;
          return [
            ...o,
            this.getRenderable(t[t.length - 1], s, n.currentBuffer(), i, e, r),
          ];
        }
        getRenderable(t, e, n, r, i, o) {
          const s = this.uniforms,
            a = this.getTextures(t, { ...o, [K]: n }, i),
            c = this.enableOneTriangleOptimisation ? Z : J;
          return new P({
            ...c,
            shader: e,
            uniforms: s,
        ...
        getShader(t, e) {
          ...
          return new I({ vertexSource: n, fragmentSource: r });
        }
        ...
        getRenderTexture(t, e) {
          ...
          if (!n)
            throw new a(
              `Unable to assign texture. Could not find texture '${t}'.`,
            );
          return n;
        }
        getTextures(t, e, n) {
        ...
        update({ textures: t, uniforms: e, renderTarget: n }) {
          if (t)
            for (const [r, i] of Object.entries(t))
              if (i) for (const t of this.renderables) t.textures[r] = i;
          if (e)
            for (const [r, i] of Object.entries(e))
              this.uniforms[r] && (this.uniforms[r] = tt(i));
          if (void 0 !== n) {
        ...
        get resources() {
          return [
            ...new Set([
              ...this.renderables.flatMap((t) => t.resources),
              this.finalPassShaderForCanvas,
              this.finalPassShaderForRenderTexture,
            ]),
          ];
      ...
      ot.enableOneTriangleOptimisation = !1;
      let st,
        at,
        ct = ot;
      function ut(t, e) {
        if (
          ...
          throw new n(
            "Unable to establish `CanvasRenderingContext2D` for debugging",
          );
        return ((st.width = t), (st.height = e), { canvas: st, context: at });
      }
      function lt(t, e) {
        const n = t.readPixels(e),
          { width: r, height: i } = n,
          { canvas: o, context: s } = ut(r, i);
        s.putImageData(n, 0, 0);
        const a = o.toDataURL();
        dt(null != e ? e : t.canvas, a, r / i);
      }
      function ht(t) {
        const { width: e, height: n } = t,
          { canvas: r, context: i } = ut(e, n);
        t.source instanceof ImageData
          ? i.putImageData(t.source, 0, 0)
          : i.drawImage(t.source, 0, 0);
        dt(t, r.toDataURL(), e / n);
      }
      function ft(t) {
        const { source: e, colorFormat: n, width: r, height: i } = t,
          { canvas: o, context: s } = ut(r, i),
          a = "rgba" === n,
          c = s.createImageData(r, i),
          u = c.data;
        for (let l = 0, h = 0; l < e.length; l += a ? 4 : 3, h += 4)
          ((u[h] = e[l]),
            (u[h + 1] = e[l + 1]),
            (u[h + 2] = e[l + 2]),
            (u[h + 3] = a ? e[l + 3] : 255));
        s.putImageData(c, 0, 0);
        dt(t, o.toDataURL(), r / i);
      }
      function dt(t, e, n) {
      ...
      const pt = "LkEaxkGQc",
        ...
        St = "MLGoNA0wv";
      var Ct = 1e-6,
        Pt = "undefined" != typeof Float32Array ? Float32Array : Array;
      function Ot() {
        var t = new Pt(9);
        return (
          Pt != Float32Array &&
      ...
      function Lt(t, e, n) {
        ...
        return (
          ...
          (t[8] = E * r + y * a + w * h + T * m),
          (t[9] = E * i + y * c + w * f + T * v),
          (t[10] = E * o + y * u + w * d + T * g),
          (t[11] = E * s + y * l + w * p + T * b),
          (E = n[12]),
          (y = n[13]),
          (w = n[14]),
          (T = n[15]),
          (t[12] = E * r + y * a + w * h + T * m),
          (t[13] = E * i + y * c + w * f + T * v),
          (t[14] = E * o + y * u + w * d + T * g),
          (t[15] = E * s + y * l + w * p + T * b),
          t
        );
      }
      function Mt(t, e) {
      ...
      function Dt(t, e, n, r) {
        ...
        return Math.abs(p - y) < Ct &&
          ...
          : ((l = p - y),
            (h = m - w),
            (f = v - T),
            (i = b * (f *= d = 1 / Math.hypot(l, h, f)) - E * (h *= d)),
            (o = E * (l *= d) - g * f),
            (s = g * h - b * l),
            (d = Math.hypot(i, o, s))
              ? ((i *= d = 1 / d), (o *= d), (s *= d))
      ...
      function Ut() {
        var t = new Pt(3);
        return (Pt != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0)), t);
      }
      function Ht(t) {
        var e = t[0],
          n = t[1],
      ...
      function jt() {
        var t = new Pt(4);
        return (
          Pt != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0)),
          (t[3] = 1),
          t
        );
      }
      ...
      const Xt = (t) => {
          if (void 0 === t.camera)
            return {
              ...
              rotation: [0, 0, 0, 0],
              scale: [1, 1, 1],
              translation: [0, 0, 0.3499999940395355],
            };
          const e =
            void 0 !== t.camera.perspective ? "perspective" : "orthographic";
        ...
        Wt = 5130562;
      var qt = ((t) => (
        (t[(t.GLTF_BUFFER_TYPE_BYTE = 5120)] = "GLTF_BUFFER_TYPE_BYTE"),
        (t[(t.GLTF_BUFFER_TYPE_UNSIGNED_BYTE = 5121)] =
          "GLTF_BUFFER_TYPE_UNSIGNED_BYTE"),
        (t[(t.GLTF_BUFFER_TYPE_SHORT = 5122)] = "GLTF_BUFFER_TYPE_SHORT"),
        (t[(t.GLTF_BUFFER_TYPE_UNSIGNED_SHORT = 5123)] =
          "GLTF_BUFFER_TYPE_UNSIGNED_SHORT"),
        (t[(t.GLTF_BUFFER_TYPE_UNSIGNED_INT = 5125)] =
          "GLTF_BUFFER_TYPE_UNSIGNED_INT"),
        (t[(t.GLTF_BUFFER_TYPE_FLOAT = 5126)] = "GLTF_BUFFER_TYPE_FLOAT"),
        t
      ))(qt || {});
      const Yt = {
          5120: Int8Array,
        ...
        Kt = async (t) => (await fetch(t)).arrayBuffer(),
      ...
      class Jt {
        ...
        async getBufferViewFromAccessor(t) {
          ...
          const e = $t[t.type],
            n = Yt[t.componentType].BYTES_PER_ELEMENT * e * t.count;
        ...
        async bufferViewData(t, e) {
          ...
          const n = this.gltf.bufferViews[t],
            ...
            a = r.byteOffset;
          switch (e) {
            case qt.GLTF_BUFFER_TYPE_BYTE:
              return new Int8Array(s, a + o, i);
            case qt.GLTF_BUFFER_TYPE_UNSIGNED_BYTE:
              return new Uint8Array(s, a + o, i);
            case qt.GLTF_BUFFER_TYPE_SHORT:
              return new Int16Array(s, a + o, i / 2);
            case qt.GLTF_BUFFER_TYPE_UNSIGNED_SHORT:
              return new Uint16Array(s, a + o, i / 2);
            case qt.GLTF_BUFFER_TYPE_UNSIGNED_INT:
              return new Uint32Array(s, a + o, i / 4);
            case qt.GLTF_BUFFER_TYPE_FLOAT:
              return new Float32Array(s, a + o, i / 4);
          }
          return new Uint8Array(s, a + o, i);
        }
        async getBufferData(t) {
          ...
          n = e.uri.includes("data:application")
            ? ((t) => {
                try {
        ...
        async getImageData(t) {
          ...
          if (void 0 !== e.bufferView) {
            const t = await this.bufferViewData(
                e.bufferView,
                qt.GLTF_BUFFER_TYPE_BYTE,
              ),
              r = new Blob([t], { type: e.mimeType });
            n = URL.createObjectURL(r);
          } else {
            if (void 0 === e.uri)
              throw new Error(
                "Invalid glTF: image must either have a `uri` or a `bufferView`",
              );
      ...
      const Qt = (t) => {
        ...
        te = async (t) => {
          ...
          if (
            ...
            return (console.log("fetch retunr external "), null);
          try {
            ((e = await (async (t) => await (await fetch(t)).json())(t)),
              (n = {
                magic: "glTF",
            ...
            ((n = ((t) => {
              ...
              ({ json: e, chunks: r } = ne(i)));
          }
          return { json: e, header: n, chunks: r };
        },
        ee = async (t) => {
          var e;
          if ("string" != typeof t)
            throw new Error("Invalid URI: String is expected.");
          const n =
            null != (e = await te(t))
              ? e
              : ((t) => {
          ...
          const { json: r, header: i, chunks: o } = n;
          if ("glTF" !== i.magic || i.version < 2)
            throw new Error(
              `File format is not supported! Current header magic: ${i.magic}, version ${i.version}`,
            );
          if (void 0 === r) throw new Error("JSON content not found.");
          if (void 0 === r.asset || parseFloat(r.asset.version) < 2)
            throw new Error(
              "Unsupported asset. glTF versions >= 2.0 are supported.",
            );
          return { json: r, chunks: o };
        },
        ne = (t) => {
          const e = [];
          let n;
          ...
          for (; i < r.byteLength; ) {
            ...
            i += 4;
            const s = r.getUint32(i, !0);
            if (((i += 4), s === zt)) {
              const e = new Uint8Array(t, 12 + i, o);
              n = JSON.parse(Zt(e));
            } else if (s === Wt) {
              const n = 12 + i;
              e.push(new Uint8Array(t, n, o));
            }
            i += o;
          }
          return { json: n, chunks: e };
        },
        re = "placeholder",
        ie = (t) =>
          t instanceof Uint16Array
        ...
        oe = (t) => {
          ...
          return (
            t.forEach((t, n) => {
              var r, i;
              t.name.toLowerCase().includes(re)
                ? e.push({ meshIndex: n, name: t.name })
                : null != (r = t.material) &&
                  r.name.toLowerCase().includes(re) &&
                  e.push({
                    meshIndex: n,
                    name: null == (i = t.material) ? void 0 : i.name,
                  });
            }),
            e
          );
        ...
        ae = (t, e) => {
              ...
              return (
                t.mesh.forEach((n, r) => {
                  const i =
                    n.uvs && n.uvs.length
                      ? n.uvs
                      : new Float32Array((n.positions.length / 3) * 2);
                  e.push({
                    ...
                    material: n.material,
                    id: r,
                    renderingContextBase: ie(n.indices),
                  });
                }),
                e
              );
          ...
          return {
            ...
            targets: se(t.mesh),
            transform:
              t.translation.length > 0
                ? Mt(
                    It(),
                    kt(t.translation[0], t.translation[1], t.translation[2]),
                  )
                : It(),
            rotation:
              t.rotation.length > 0
            ...
            scale:
              t.scale.length > 0
                ? kt(t.scale[0], t.scale[1], t.scale[2])
                : kt(1, 1, 1),
            name: t.name,
            parrent: e,
            ...
            animation: {
              ...
              scale: { times: new Uint8Array(), values: [], interpolation: "" },
              weights: {
                times: new Uint8Array(),
        ...
        ce = (t = -1, e = "", n = []) => ({
          ...
          translation: [],
          camera: void 0,
          extras: { highlightCorrection: 1, shadowCorrection: 1 },
        });
      const ue = kt(0, 1, 0),
        le = [0.5 * Math.PI, 0.5 * Math.PI];
      ((e.AdditiveBlending = {
        source: "src alpha",
        destination: "one",
        equation: "add",
        ...
        (e.Effect = ct),
        (e.ElementsBuffer = w),
        (e.FraglAllocationError = i),
        (e.FraglCompilationError = r),
        (e.FraglError = n),
        (e.FraglInternalError = c),
        (e.FraglPlatformError = s),
        (e.FraglRuntimeError = o),
        (e.FraglValidationError = a),
        (e.GltfParser = class {
          constructor(t) {
            ((this.src = t),
              (this.camera = ce()),
              (this.cameraModel = Xt(this.camera)),
              (this.nodes = []),
              (this.clips = []),
              (this.model = []),
              (this.images = []),
          ...
          async parse(t = {}) {
            return (
              (this.model = []),
              (this.asset = await (async (t) => {
                const e = Qt(t),
                  n = await ee(t);
                return new Jt(e, n.json, n.chunks);
              })(this.src)),
              (this.images = await this.getTextureImages(
                t.imageFilesToReplace,
              )),
              this.updateTexturesData(),
              (this.camera = ce()),
              (this.nodes = await this.getSubNodes()),
              (this.cameraModel = this.getCameraModel()),
              (this.clips = await this.getClips()),
          ...
          async getModel(t, e, n = []) {
            const r = (void 0 === t ? this.nodes : t).map((t) => {
              const r = ae(t, e);
              return (
                t.children.length > 0 && this.getModel(t.children, t, n),
                r
              );
            });
          ...
          updateAnimation() {
            (this.clips.forEach((t) => {
              t.tracks.forEach((t) => {
                const e = this.model.findIndex(
                  (e) => e.name === t.targetObject,
                );
                if (e > -1) {
                  const n = this.model[e];
                  switch (t.targetProperty.toLocaleLowerCase()) {
                    case "translation":
                      ((n.animation.transform.values =
                        this.decodeVector3Animation(
                          t.values,
                          t.valuesElements,
                        )),
                        (n.animation.transform.times = t.times),
                        (n.animation.transform.interpolation =
                          t.interpolation));
                      break;
                    case "rotation":
                      ((n.animation.rotation.values =
                        this.decodeQuaternionAnimation(
                          t.values,
                          t.valuesElements,
                        )),
                        (n.animation.rotation.times = t.times),
                        (n.animation.rotation.interpolation = t.interpolation));
                      break;
                    case "scale":
                      ((n.animation.scale.values = this.decodeVector3Animation(
                        t.values,
                        t.valuesElements,
                      )),
                        (n.animation.scale.times = t.times),
                        (n.animation.scale.interpolation = t.interpolation));
                      break;
                    case "weights":
                      n.targets.length > 0 &&
                        ((n.animation.weights.targets = this.model[e].targets),
                        (n.animation.weights.times = t.times),
                        (n.animation.weights.values = t.values),
                        (n.animation.weights.interpolation = t.interpolation),
                        ((t, e) => {
                          ...
                          for (let r = 0; r < n; r++) {
                            const n = r * t.targets.length,
                              i = [];
                            for (let r = 0; r < e; r += 3) {
                              ((i[r] = 0), (i[r + 1] = 0), (i[r + 2] = 0));
                              for (let e = 0; e < t.targets.length; e++) {
                                const o = n + e;
                                ((i[r] +=
                                  t.targets[e].positions[r] * t.values[o]),
                                  (i[r + 1] +=
                                    t.targets[e].positions[r + 1] *
                                    t.values[o]),
                                  (i[r + 2] +=
                                    t.targets[e].positions[r + 2] *
                                    t.values[o]));
                              }
                            }
                            t.positions[r] = new Float32Array(i);
                          }
                        })(
                          n.animation.weights,
                          this.getModelVerticesLength(n.mesh),
                        ));
                  }
                }
              });
            }),
              this.cameraModel.id > -1 &&
                ((this.cameraModel.animation =
                  this.model[this.cameraModel.id].animation),
                (this.model = this.model.filter(
                  (t) => !t.name.toLocaleLowerCase().includes("camera"),
                ))));
          }
          ...
          getTracks(t) {
            ...
            return Promise.all(
              t.channels.map(async (n) => {
                var r;
                const i = t.samplers[n.sampler],
                  o = await e.accessorData(i.input),
                  s = await e.accessorData(i.output);
                return {
                  targetIndex: n.target.node,
                  targetObject: e.gltf.nodes[n.target.node].name,
                  targetProperty: n.target.path,
                  interpolation: null != (r = i.interpolation) ? r : "LINEAR",
                  times: o.buffer,
                  timesElements: o.elementsPerType,
                  values: s.buffer,
          ...
          getCameraModel() {
            return Xt(this.camera);
          }
          updateTexturesData() {
            var t;
            ((this.textures = []), (this.samplers = []));
            const e = this.getGltfFromAsset();
            ((this.samplers = null != (t = e.samplers) ? t : []),
              void 0 !== e.textures &&
                e.textures.forEach((t, e) => {
                  t &&
                    (this.textures[e] = {
                      sampler: t.sampler,
                      source: t.source,
          ...
          replaceImages(t, e) {
            ...
            if (!n)
              throw new a(`No image file found with the name of: ${t.name}`);
            return n;
          }
          async getTextureImages(t) {
            if (void 0 === this.asset || void 0 === this.asset.gltf.images)
              return [];
            const e = this.asset.gltf.images.map(async (e, n) => {
              var r;
              return t
                ? this.replaceImages(e, t)
                : {
                    mimeType: e.mimeType,
                    name: e.name,
                    img: await (null == (r = this.asset)
                      ? void 0
                      : r.getImageData(n)),
                  };
            });
          ...
          async getSubNodes(t, e) {
            const n = this.getGltfFromAsset(),
              r = 0 | n.scene,
              i = n.scenes[r],
              o = (void 0 === t ? i.nodes : t).map(async (t) => {
                const r = n.nodes[t],
                  i = ce(t, r.name);
                return (
                  void 0 !== r.children &&
                    (i.children = await this.getSubNodes(r.children, r)),
                  void 0 !== r.mesh &&
                    (i.mesh = await this.getSubMesh(n.meshes[r.mesh])),
                  (i.rotation = [0, 0, 0, 0]),
                  void 0 !== r.rotation
                    ? (i.rotation = r.rotation)
                    : void 0 !== e &&
                      void 0 !== e.rotation &&
                      ((i.rotation[0] = i.rotation[0] * e.rotation[0]),
                      (i.rotation[1] = i.rotation[1] * e.rotation[1]),
                      (i.rotation[2] = i.rotation[2] * e.rotation[2]),
                      (i.rotation[3] = i.rotation[3] * e.rotation[3])),
                  (i.translation = [0, 0, 0]),
                  void 0 !== r.translation
                    ? (i.translation = r.translation)
                    : void 0 !== e &&
                      void 0 !== e.translation &&
                      ((i.translation[0] = i.translation[0] * e.translation[0]),
                      (i.translation[1] = i.translation[1] * e.translation[1]),
                      (i.translation[2] = i.translation[2] * e.translation[2])),
                  (i.scale = [1, 1, 1]),
                  void 0 !== r.scale
                    ? (i.scale = r.scale)
                    : void 0 !== e &&
                      void 0 !== e.scale &&
                      ((i.scale[0] = i.scale[0] * e.scale[0]),
                      (i.scale[1] = i.scale[1] * e.scale[1]),
                      (i.scale[2] = i.scale[2] * e.scale[2])),
                  void 0 !== r.camera &&
                    ((i.camera = n.cameras[r.camera]), (this.camera = i)),
                  (i.extras = void 0),
                  void 0 !== r.extras &&
                    ((i.extras = {
                    ...
                    (i.extras.highlightCorrection =
                      void 0 !== r.extras.Highlight_Correction
                        ? r.extras.Highlight_Correction
                        : 1),
                    (i.extras.shadowCorrection =
                      void 0 !== r.extras.Shadow_Correction
                        ? r.extras.Shadow_Correction
                        : 1)),
                  i
                );
              });
          ...
          getMaterial(t) {
            ...
            return (
              void 0 !== e.pbrMetallicRoughness &&
                (void 0 === e.pbrMetallicRoughness.metallicFactor &&
                  (e.pbrMetallicRoughness.metallicFactor = 1),
                void 0 === e.pbrMetallicRoughness.roughnessFactor &&
                  (e.pbrMetallicRoughness.roughnessFactor = 1),
                void 0 === e.pbrMetallicRoughness.baseColorFactor &&
                  (e.pbrMetallicRoughness.baseColorFactor = [1, 1, 1, 1])),
              e
            );
          }
          async getTargets(t) {
            const e = this.getAsset(),
              n = t.targets.map(async (t) => {
                ...
                return (
                  void 0 !== t.POSITION &&
                    (n.positions = (await e.accessorData(t.POSITION)).buffer),
                  void 0 !== t.NORMAL &&
                    (n.normals = (await e.accessorData(t.NORMAL)).buffer),
                  void 0 !== t.TANGENT &&
                    (n.tangent = (await e.accessorData(t.TANGENT)).buffer),
                  n
                );
              });
              ...
              n = t.primitives.map(async (t) => {
                ...
                if (
                  (void 0 !== t.attributes.POSITION &&
                    (n.positions = (
                      await e.accessorData(t.attributes.POSITION)
                    ).buffer),
                  void 0 !== t.attributes.NORMAL &&
                    (n.normals = (
                      await e.accessorData(t.attributes.NORMAL)
                    ).buffer),
                  void 0 !== t.attributes.TEXCOORD_0 &&
                    ((n.uvs = (
                      await e.accessorData(t.attributes.TEXCOORD_0)
                    ).buffer),
                    0 === n.uvs.length &&
                      (n.uvs = new Float32Array((n.positions.length / 3) * 2))),
                  void 0 !== t.attributes.TANGENT &&
                    (n.tangent = (
                      await e.accessorData(t.attributes.TANGENT)
                    ).buffer),
                  void 0 !== t.indices)
                ) {
                ...
                return (
                  void 0 !== t.targets &&
                    (n.targets = await this.getTargets(t)),
                  void 0 !== t.material &&
                    (n.material = this.getMaterial(t.material)),
                  n
                );
              });
            return Promise.all(n);
        ...
        (e.MockWebGLRenderingContext = class {
          ...
          getShaderPrecisionFormat() {
            return { rangeMin: 127, rangeMax: 127, precision: 127 };
          }
          getShaderSource() {
            return "";
          }
        ...
        (e.ModelViewer = class {
          ...
          updateAll({ uniforms: t }) {
            if (t)
              for (const e of this.renderables)
                (t.uCameraPosition && (e.uniforms[St] = t.uCameraPosition),
                  t.uMVPMatrix && (e.uniforms[At] = t.uMVPMatrix),
                  t.uNormalMatrix && (e.uniforms[Rt] = t.uNormalMatrix));
          }
          updateOne({ id: t, textures: e }) {
            const n = this._renderables[t];
            if (!n) throw new a(`Renderable with id ${t} not found`);
            e &&
              e.uPlaceholderTexture &&
        ...
        (e.ModelViewerGltfData = class {
          constructor(t, e = !1) {
            ((this.gltf = t),
              (this.meshes = this.gltf.model.map((t) => t.mesh).flat()),
              (this.shader = new I({
                vertexSource:
          ...
          getRenderables() {
            return Object.fromEntries(
              this.meshes.map((t) => [t.name, this.gltfMeshToRenderable(t)]),
            );
          }
          gltfMeshToRenderable(t) {
            ...
            const {
                ...
                roughnessFactor: o,
                roughnessTexture: a,
                isRoughnessTexture: c,
                normalTexture: u,
                isNormalTexture: l,
                placeholder: h,
                isPlaceholderTexture: f,
                isDoubleSided: d,
              } = this.gltfMaterialToTextures(
                t.material,
                this.gltf.images,
                this.gltf.textures,
              ),
            ...
            return new P({
              ...
              depthTest: { mask: !0, func: "less", range: { near: 0, far: 1 } },
              ...(!d && { cullFace: "back" }),
            });
          }
          gltfMaterialToTextures(t, e, n) {
            const r = t.pbrMetallicRoughness.baseColorFactor,
              i = t.pbrMetallicRoughness.metallicFactor,
              o = t.pbrMetallicRoughness.roughnessFactor,
              s = void 0 !== t.pbrMetallicRoughness.baseColorTexture,
              a = t.pbrMetallicRoughness.baseColorTexture
                ? new M({
                    source:
                      e[n[t.pbrMetallicRoughness.baseColorTexture.index].source]
                        .img,
                    anisotropy: 16,
                  })
                : Vt,
              c = t.normalTexture
                ...
                : Vt,
              u = void 0 !== t.normalTexture,
              l = t.pbrMetallicRoughness.metallicRoughnessTexture
                ? new M({
                    source:
                      e[
                        n[t.pbrMetallicRoughness.metallicRoughnessTexture.index]
                          .source
                      ].img,
                    anisotropy: 16,
                  })
                : Vt,
              h = void 0 !== t.pbrMetallicRoughness.metallicRoughnessTexture,
              f = t.name.includes("placeholder");
            return {
              baseColorFactor: r,
              baseColorTexture: a,
              metallicFactor: i,
          ...
          getDataToUpdateAllPlaceholders(t) {
            return this.meshes
              .filter((t) => {
                var e;
                return null == (e = t.material)
                  ? void 0
                  : e.name.includes("placeholder");
              })
              .map((e) => ({
                id: e.name,
                textures: {
                  uPlaceholderTexture: new M({ source: t, anisotropy: 16 }),
                },
              }));
          }
          getDataToUpdateSinglePlaceholder(t, e) {
            ...
            return {
              id: t,
              textures: {
                uPlaceholderTexture: new M({ source: e, anisotropy: 16 }),
              },
            };
          }
        }),
        (e.OrbitControls = class {
          constructor(
            ...
            if (
              ...
              (this.clientSizeRatio = [1, 1]),
              (this.isMouseDown = !1),
              (this.projectionMatrix = It()),
              (this.viewMatrix = It()),
              (this.modelMatrix = It()),
              (this.modelViewProjectionMatrix = It()),
              (this.cameraPosition = Ut()),
              (this.onMouseDown = (t) => {
                (t.preventDefault(),
                  (this.mousePosition[0] = t.x),
                  (this.mousePosition[1] = t.y),
                  (this.clientSizeRatio[0] =
                    window.innerWidth / this.container.clientWidth),
                  (this.clientSizeRatio[1] =
              ...
              (this.onMouseMove = (t) => {
                ...
                const { x: e, y: n } = t,
                  r = e - this.mousePosition[0],
                  i = n - this.mousePosition[1],
                  o = 0.3 * Math.sqrt(this.distance);
                ((this.velocity[0] = r * o * this.clientSizeRatio[0]),
                  (this.velocity[1] = i * o * this.clientSizeRatio[1]),
                  (this.mousePosition[0] = e),
                  (this.mousePosition[1] = n),
                  this.tick());
              }),
              (this.onMouseUp = (t) => {
                ((this.isMouseDown = !1),
                  t.target === this.container && t.preventDefault());
              }),
              (this.onWheelMove = (t) => {
              ...
              (this.tick = () => {
                ((this.rotation[0] += 0.01 * this.velocity[0]),
                  (this.rotation[1] -= 0.01 * this.velocity[1]),
                  (this.rotation[0] =
                    (this.rotation[0] + 2 * Math.PI) % (2 * Math.PI)),
                  (this.rotation[1] = Math.min(
                    0.99 * Math.PI,
                    Math.max(0.01, this.rotation[1]),
                  )),
              ...
              (this.moveToRotation = (t, e) => {
                (null != t &&
                  (this.rotation[0] = (t + 2 * Math.PI) % (2 * Math.PI)),
                  null != e &&
                    (this.rotation[1] = Math.min(
                      0.99 * Math.PI,
                      Math.max(0.01, e),
              ...
              (this.loadCameraSettings = ({
                ...
                (this.zoomToDistance(t),
                  this.enableZooming && null != e
                    ? ((this.minDistance = e.min),
                      (this.maxDistance = e.max),
                      this.toggleZooming(!0))
                    : this.toggleZooming(!1));
              }),
              (this.zoomToDistance = (t) => {
                null != t &&
              ...
              throw new a(
                "Invalid value of minDistance. Expected value must be greater than 0.",
              );
            ((this.enableZooming = s),
              (this.distance = null != e ? e : 1.5),
              (this.minDistance = null != n ? n : 0.1),
              (this.maxDistance = null != r ? r : 20),
              (this.rotationTarget = null != o ? o : "camera"),
              (this.rotation = null != i ? i : le),
              this.updateCameraPosition(),
              this.container.addEventListener(
                "mousedown",
                this.onMouseDown,
          ...
          createViewMatrix(t) {
            if ("model" === this.rotationTarget) {
              const e = [0, 0, Ht(t)];
              Dt(this.viewMatrix, e, t, ue);
            } else Dt(this.viewMatrix, t, t, ue);
            return this.viewMatrix;
          }
          createModelMatrix() {
            if ((Nt(this.modelMatrix), "model" === this.rotationTarget)) {
          ...
          createMVPMatrix(t) {
            (this.createModelMatrix(),
              this.createViewMatrix(this.cameraPosition),
              Bt(this.projectionMatrix, 0.4, t, 0.01, 1e3));
            const e = kt(0, 0, 0),
              n = kt(0, 1, 0);
            return (
              Dt(this.viewMatrix, this.cameraPosition, e, n),
              Lt(
              ...
              Array.from(this.modelViewProjectionMatrix)
            );
          }
          updateCameraPosition() {
            const [t, e] =
              "camera" === this.rotationTarget ? this.rotation : le;
            ((this.cameraPosition[0] =
              this.distance * Math.cos(t) * Math.sin(e)),
              (this.cameraPosition[1] = this.distance * Math.cos(e)),
              (this.cameraPosition[2] =
                this.distance * Math.sin(t) * Math.sin(e)));
          }
          createNormalMatrix() {
            const t = Ot();
            return (
        ...
        (e.PingpongBuffers = it),
        (e.PremultipliedNormalBlending = {
          source: "one",
        ...
        (e.Renderer = class {
          ...
          restore() {
            (this.backend.dispose(),
              (this.backend = this.createBackend()),
              this.backend.load(Array.from(this.resources.values())));
          }
          resize(...t) {
            const [e, n] = t;
            if (e === this.canvas.width && n === this.canvas.height) return;
            this.backend.resize(...t);
            const r = Array.from(this.resources.values()).filter(
              (t) =>
                "texture" === t.resourceType &&
                !t.source &&
                "relative" === t.size,
            );
        ...
        (e.Shader = I),
        (e.WebGlRenderer = $),
        (e._renderTexturePool = nt),
        (e.createWebGlRenderer = function (t, e) {
          var n, r, o;
          ...
          s.addEventListener("webglcontextcreationerror", c);
          const u = {
              alpha: null == (n = null == e ? void 0 : e.alpha) || n,
              antialias: null == (r = null == e ? void 0 : e.antialias) || r,
              depth: null != (o = null == e ? void 0 : e.depth) && o,
              stencil: !1,
              preserveDrawingBuffer: !(null == e || !e.preserveDrawingBuffer),
              powerPreference: "high-performance",
              failIfMajorPerformanceCaveat: !(
                null == e || !e.failIfMajorPerformanceCaveat
              ),
            },
            l =
              null != e && e.useWebGl2
                ? s.getContext("webgl2", u)
                : s.getContext("webgl", u);
          if ((s.removeEventListener("webglcontextcreationerror", c), !l))
            throw new i(`A WebGL context could not be created. Reason: ${a}`);
          return new $(l, {
            ...e,
            onDispose: () => {
              s.remove();
        ...
        (e.debugBinaryTexture = ft),
        (e.debugImageTexture = ht),
        (e.debugRenderTexture = lt),
        (e.debugTexture = function (t, e) {
          e && "render" !== e.textureType
            ? "image" === e.textureType
              ? ht(e)
              : ft(e)
            : lt(t, e);
        }),
        (e.getAbsoluteTextureSize = D),
        (e.getPooledRenderTexture = rt),
        (e.injectAlphaPremultiplication = Q),
        (e.paddedTuple = function (t, e, n) {
            ...
            (function (t, e) {
              ...
              for (
                ...
                (e && (r ^= e.charCodeAt((o + 32) % e.length)),
                  ...
                  o >= 0 &&
                    ((s = (s + 1640531527) | 0),
                    (i = 0 == (n = a[127 & o] ^= r + s) ? i + 1 : 0)));
              for (
                i >= 128 && (a[127 & ((e && e.length) || 0)] = -1),
                  i = 127,
                  o = 512;
                o > 0;
                --o
            ...
            (e.prototype._subscribe = function (t) {
              ...
              return this.hasError
                ...
                : this.isStopped
                  ...
                  : (this.observers.push(t), new c.Y(this, t));
            }),
    ...
    493036: (t, e, n) => {
      ...
      const o = function (t, e) {
        ...
        var n,
          ...
          u = a || c;
        if (
          (t && r(t) ? (s = o) : o.length && (s.pop(), (s = s.concat(o))),
          !s.length)
        )
          return "/";
        if (s.length) {
    ...
    523546: (t, e, n) => {
      ...
      var r = [
        ...
        c = function t(e, n) {
          ...
          void 0 === n && (n = !0);
          var i =
            null == e || null === (r = e.getAttribute) || void 0 === r
              ? void 0
              : r.call(e, "inert");
          return "" === i || "true" === i || (n && e && t(e.parentNode));
        },
        u = function (t, e, n) {
          if (c(t)) return [];
          var r = Array.prototype.slice.apply(t.querySelectorAll(i));
          return (e && s.call(t, i) && r.unshift(t), (r = r.filter(n)));
        },
        l = function t(e, n, r) {
            ...
            if (!c(u, !1))
              if ("SLOT" === u.tagName) {
                var l = u.assignedElements(),
                  h = t(l.length ? l : u.children, !0, r);
                r.flatten
                  ? o.push.apply(o, h)
                  : o.push({ scopeParent: u, candidates: h });
              } else {
                s.call(u, i) &&
                  r.filter(u) &&
                  (n || !e.includes(u)) &&
                ...
                var f =
                    ...
                    ("function" == typeof r.getShadowRoot &&
                      r.getShadowRoot(u)),
                  d =
                    !c(f, !1) && (!r.shadowRootFilter || r.shadowRootFilter(u));
                if (f && d) {
                  var p = t(!0 === f ? u.children : f.children, !0, r);
                  r.flatten
                    ? o.push.apply(o, p)
                    : o.push({ scopeParent: u, candidates: p });
        ...
        g = function (t, e) {
          ...
          var i = s.call(t, "details>summary:first-of-type")
            ? t.parentElement
            : t;
            ...
            if ("function" == typeof r) {
              for (var o = t; t; ) {
                var c = t.parentElement,
                  u = a(t);
                if (c && !c.shadowRoot && !0 === r(c)) return v(t);
                t = t.assignedSlot
                  ? t.assignedSlot
                  : c || u === t.ownerDocument
                    ? c
            ...
            if (
              (function (t) {
                var e,
                  ...
                  i,
                  o = t && a(t),
                  s = null === (e = o) || void 0 === e ? void 0 : e.host,
                  c = !1;
                if (o && o !== t)
                  for (
                    c = !!(
                    ...
                    c = !(
                      null ===
                        (l = s =
                          null === (u = o = a(s)) || void 0 === u
                            ? void 0
                            : u.host) ||
                      void 0 === l ||
                      null === (h = l.ownerDocument) ||
                      void 0 === h ||
                      !h.contains(s)
                    );
                  }
                ...
                for (var e = t.parentElement; e; ) {
                  if ("FIELDSET" === e.tagName && e.disabled) {
                    for (var n = 0; n < e.children.length; n++) {
                      ...
                      if ("LEGEND" === r.tagName)
                        return (
                          !!s.call(e, "fieldset[disabled] *") || !r.contains(t)
                        );
                    }
                    return !0;
                  }
        ...
        T = function (t, e) {
          ...
          return (
            (n = (e = e || {}).getShadowRoot
              ? l([t], e.includeContainer, {
                  filter: E.bind(null, e),
                  flatten: !1,
                  getShadowRoot: e.getShadowRoot,
                  shadowRootFilter: y,
                })
              : u(t, e.includeContainer, E.bind(null, e))),
            w(n)
          );
        },
        _ = function (t, e) {
          if (((e = e || {}), !t)) throw new Error("No node provided");
          return !1 !== s.call(t, i) && E(e, t);
        };
    },
    536618: (t, e, n) => {
      "use strict";
      ...
      function f(t, e) {
        ...
        var n = t;
        (t.then(
          (0, r.XI)("observableFromPromise-resolve", function (t) {
            ((n.value = t), (n.state = u));
          }),
          (0, r.XI)("observableFromPromise-reject", function (t) {
            ((n.value = t), (n.state = l));
          }),
        ),
          (n.isPromiseBasedObservable = !0),
          (n.case = h));
        var i = !e || (e.state !== u && e.state !== c) ? void 0 : e.value;
        return ((0, r.kt)(n, { value: i, state: c }, {}, { deep: !1 }), n);
      }
      !(function (t) {
        ((t.reject = (0, r.XI)("fromPromise.reject", function (e) {
          var n = t(Promise.reject(e));
          return ((n.state = l), (n.value = e), n);
        })),
          (t.resolve = (0, r.XI)("fromPromise.resolve", function (e) {
            void 0 === e && (e = void 0);
      ...
      function d(t, e, n) {
        (void 0 === e && (e = i), void 0 === n && (n = void 0));
        var s = !1,
          a = !1,
          c = n,
          u = function () {
        ...
        return {
          current: function () {
            return (
              o(!a, "subscribingObservable has already been disposed"),
              l.reportObserved() ||
                s ||
                console.warn(
      ...
      !(function () {
        ...
        (Object.defineProperty(t.prototype, "dispose", {
          ...
          p([r.sH.ref], t.prototype, "current", void 0),
          p([r.XI.bound], t.prototype, "next", null),
          p([r.XI.bound], t.prototype, "complete", null),
          p([r.XI.bound], t.prototype, "error", null));
      })();
      var v = function () {
          return (
            (v =
      ...
      !(function () {
        function t(t) {
          ...
          (Object.defineProperty(this, "model", {
            ...
            (0, r.Gn)(this),
            o((0, r.OB)(t), "createViewModel expects an observable object"));
          var n = a(this);
          a(t).forEach(function (i) {
            ...
            if (
              !n.includes(i) &&
              i !== r.BQ &&
              "__mobxDidRunLazyInitializers" !== i
            ) {
              if (
                (o(
                  -1 === b.indexOf(i),
                ...
                var a = (0, r.Mr)(t, i),
                  c = a.derivation.bind(e),
                  u =
                    null === (s = a.setter_) || void 0 === s
                      ? void 0
                      : s.bind(e);
                e.localComputedValues.set(i, (0, r.EW)(c, { set: u }));
              }
              var l = Object.getOwnPropertyDescriptor(t, i),
                h = l ? { enumerable: l.enumerable } : {};
              Object.defineProperty(
                ...
                v(v({}, h), {
                  ...
                  get: function () {
                    return (0, r.H8)(t, i)
                      ? e.localComputedValues.get(i).get()
                      : e.isPropertyDirty(i)
                        ? e.localValues.get(i)
                        : e.model[i];
                  },
                  set: (0, r.XI)(function (n) {
                    (0, r.H8)(t, i)
                      ? e.localComputedValues.get(i).set(n)
                      : n !== e.model[i]
                        ? e.localValues.set(i, n)
                        : e.localValues.delete(i);
                  }),
                }),
              );
            }
        ...
        (Object.defineProperty(t.prototype, "isDirty", {
          ...
          Object.defineProperty(t.prototype, "submit", {
            ...
            value: function () {
              var t = this;
              ((0, r.HP)(this.localValues).forEach(function (e) {
          ...
          g([r.EW], t.prototype, "isDirty", null),
          g([r.EW], t.prototype, "changedValues", null),
          g([r.XI.bound], t.prototype, "submit", null),
          g([r.XI.bound], t.prototype, "reset", null),
          g([r.XI.bound], t.prototype, "resetProperty", null));
      })();
      function E(t, e) {
        var n = (0, r.go)(t, e);
        if (!n)
      ...
      function A(t, e) {
        ...
        return function (e) {
          ...
          if (!a && !(0, r.Tx)()) {
            !u &&
              (null !== (o = i.requiresReaction) && void 0 !== o
                ? o
                : (0, r.sG)().computedRequiresReaction) &&
              (console.warn(
          ...
          return (
            (l = (function (e) {
              ...
              if (!a)
                var f = (0, r.q$)(h, function () {
                  (n.delete(e), f(), c && c(o, e));
                });
              return h;
            })(e)),
            n.set(e, l),
        ...
        S =
          ((function (t) {
            function e(e, n, i) {
              ...
              return (
                (l._disposeBaseObserver = (0, r.lB)(l._base, function (t) {
                  if ("splice" === t.type)
                    (0, r.Rn)(function () {
          ...
          (function () {
            function t(t, e, n, r) {
              ...
              for (
                var i = (this.closest = this.root = t), o = 0;
                o < this.args.length - 1 && (i = i.get(e[o]));
                o++
              )
                this.closest = i;
              this.closestIdx = o;
            ...
            return (
              Object.defineProperty(t.prototype, "exists", {
                ...
                value: function () {
                  ...
                  return (
                    this.closestIdx >= t - 1 &&
                    this.closest.has(this.args[t - 1])
                  );
                },
              }),
            ...
            Object.defineProperty(t.prototype, "entry", {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  this.currentVersion++,
                  new S(this.store, t, this.currentVersion, this.checkVersion)
                );
              },
            }),
            t
      ...
      function I(t, e) {
        ...
        var n = !1,
          ...
          s = new C();
        return function () {
          for (var e, a = this, c = [], u = 0; u < arguments.length; u++)
            c[u] = arguments[u];
          var l,
            h = s.entry(c);
          if (h.exists()) return h.get().get();
          if (!o.keepAlive && !(0, r.Tx)()) {
            !n &&
              (null !== (e = o.requiresReaction) && void 0 !== e
                ? e
                : (0, r.sG)().computedRequiresReaction) &&
              (console.warn(
            ...
            return (o.onCleanup && o.onCleanup.apply(o, O([f], c)), f);
          }
          var d = (0, r.EW)(
            function () {
              return (l = t.apply(a, c));
            },
            P(P({}, o), {
              name: "computedFn(" + (o.name || t.name) + "#" + ++i + ")",
            }),
          );
          return (
            h.set(d),
            o.keepAlive ||
              (0, r.q$)(d, function () {
                (s.entry(c).delete(),
                  o.onCleanup && o.onCleanup.apply(o, O([l], c)),
                  (l = void 0));
              }),
            d.get()
          );
    ...
    552675: (t, e, n) => {
      ...
      function h(t, e) {
        if (null != t) {
          ...
          if ((0, c.y)(t)) return (0, i.P)(t, e);
          if ((0, u.X)(t)) return (0, o.V)(t, e);
    ...
    553824: (t, e, n) => {
      ...
      function o(t) {
        ...
        for (
          var e = [],
            n = 0,
            r = t.split(i.R).filter(function (t) {
              return t.length > 0;
            });
          n < r.length;
          n++
          ...
          for (var s = o[0], a = o.slice(1), c = 0, u = a; c < u.length; c++) {
            if (0 === u[c].length) throw new Error("Invalid number skeleton");
          }
          e.push({ stem: s, options: a });
        }
        return e;
      }
      var s = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,
      ...
      function p(t) {
        for (var e = {}, n = 0, i = t; n < i.length; n++) {
          ...
          switch (o.stem) {
            ...
            case "scientific":
              e = (0, r.Cl)(
                (0, r.Cl)((0, r.Cl)({}, e), { notation: "scientific" }),
                o.options.reduce(function (t, e) {
                  return (0, r.Cl)((0, r.Cl)({}, t), d(e));
                }, {}),
              );
              continue;
            case "engineering":
              e = (0, r.Cl)(
                (0, r.Cl)((0, r.Cl)({}, e), { notation: "engineering" }),
                o.options.reduce(function (t, e) {
                  return (0, r.Cl)((0, r.Cl)({}, t), d(e));
                }, {}),
              );
            ...
            case "integer-width":
              ...
              o.options[0].replace(c, function (t, n, r, i, o, s) {
          ...
          if (u.test(o.stem)) e.minimumIntegerDigits = o.stem.length;
          else if (s.test(o.stem)) {
            if (o.options.length > 1)
              throw new RangeError(
                "Fraction-precision stems only accept a single optional option",
              );
            o.stem.replace(s, function (t, n, r, i, o, s) {
              return (
                "*" === r
            ...
            "w" === p
              ...
              : p && (e = (0, r.Cl)((0, r.Cl)({}, e), l(p)));
          } else if (a.test(o.stem)) e = (0, r.Cl)((0, r.Cl)({}, e), l(o.stem));
          else {
            var m = h(o.stem);
            m && (e = (0, r.Cl)((0, r.Cl)({}, e), m));
            var v = f(o.stem);
    ...
    589916: (t, e, n) => {
      ...
      function a(t, e) {
        ...
        if (t && e && "object" == typeof t) {
          ...
          if (
            ((i = Object.keys(t)), (n = i.length), n !== Object.keys(e).length)
          )
            return !1;
          for (r = n; 0 != r--; )
      ...
      function h(t) {
        ...
        const {
          ...
          [y, w] = i.useState(h);
        a(y, h) || w(h);
        const [T, _] = i.useState(null),
          [A, x] = i.useState(null),
          R = i.useCallback((t) => {
            t !== O.current && ((O.current = t), _(t));
          }, []),
          S = i.useCallback((t) => {
            t !== I.current && ((I.current = t), x(t));
          }, []),
          C = d || T,
          P = p || A,
          O = i.useRef(null),
          ...
          B = i.useCallback(() => {
            ...
            const t = { placement: e, strategy: n, middleware: y };
            (F.current && (t.platform = F.current),
              (0, r.rD)(O.current, I.current, t).then((t) => {
        ...
        (s(
          ...
          s(() => {
            if ((C && (O.current = C), P && (I.current = P), C && P)) {
              if (M.current) return M.current(C, P, B);
              B();
            }
          }, [C, P, B, M, L]));
        const U = i.useMemo(
          ...
          H = i.useMemo(() => ({ reference: C, floating: P }), [C, P]),
          k = i.useMemo(() => {
            const t = { position: n, left: 0, top: 0 };
            if (!H.floating) return t;
            const e = u(H.floating, b.x),
              r = u(H.floating, b.y);
            return m
              ? {
                  ...t,
                  transform: "translate(" + e + "px, " + r + "px)",
                  ...(c(H.floating) >= 1.5 && { willChange: "transform" }),
                }
              : { position: n, left: e, top: r };
          }, [n, m, H.floating, b.x, b.y]);
        return i.useMemo(
          () => ({ ...b, update: B, refs: U, elements: H, floatingStyles: k }),
          [b, B, U, H, k],
        );
      }
      const f = (t) => ({
        ...
        d = (t, e) => ({ ...(0, r.cY)(t), options: [t, e] }),
        p = (t, e) => ({ ...(0, r.BN)(t), options: [t, e] }),
        m = (t, e) => ({ ...(0, r.UU)(t), options: [t, e] }),
        v = (t, e) => ({ ...(0, r.jD)(t), options: [t, e] }),
        g = (t, e) => ({ ...f(t), options: [t, e] });
    },
    594314: (t, e, n) => {
      "use strict";
      n.d(e, { A: () => m, m: () => d });
      ...
      ((p.displayName = "Measure"), (p.propTypes.children = c().func));
      const m = p;
    },
    607597: (t, e, n) => {
      "use strict";
        ...
        t.forEach(function (t) {
          if ((delete t.location, (0, s.Jp)(t) || (0, s.N6)(t)))
            for (var e in t.options)
              (delete t.options[e].location, a(t.options[e].value));
          else
            ((0, s.oF)(t) && (0, s.N1)(t.style)) ||
            (((0, s.tv)(t) || (0, s.Qh)(t)) && (0, s.Tu)(t.style))
              ? delete t.style.location
              : (0, s.xm)(t) && a(t.children);
        });
      }
      function c(t, e) {
        (void 0 === e && (e = {}),
        ...
        var n = new o.i(t, e).parse();
        if (n.err) {
          var s = SyntaxError(i.F[n.err.kind]);
          throw (
            (s.location = n.err.location),
            (s.originalMessage = n.err.message),
            s
          );
        }
    ...
    607768: (t, e, n) => {
      ...
      function y(t) {
        return (0, r.sb)(t) && t.matches(E);
      }
      function w(t) {
        (t.preventDefault(), t.stopPropagation());
      }
      function T(t) {
        return !!t && "combobox" === t.getAttribute("role") && y(t);
      }
    },
    612151: (t, e, n) => {
      "use strict";
      ...
      const r = ["top", "right", "bottom", "left"],
        i = ["start", "end"],
        o = r.reduce((t, e) => t.concat(e, e + "-" + i[0], e + "-" + i[1]), []),
        s = Math.min,
        a = Math.max,
        c = Math.round,
        u = Math.floor,
      ...
      function A(t, e, n, r) {
        ...
        return (
          i && ((o = o.map((t) => t + "-" + i)), e && (o = o.concat(o.map(_)))),
          o
        );
      }
      function x(t) {
      ...
      function r(t, e, n, i) {
        ...
        function c(t, e) {
          ...
          if (1 === t) {
            ...
            (void 0 !== e.get && a(e.get, "accessor.get"),
              void 0 !== e.set && a(e.set, "accessor.set"),
              void 0 !== e.init && a(e.init, "accessor.init"));
          } else if ("function" !== n) {
            var r;
            throw (
              (r = 0 === t ? "field" : 10 === t ? "class" : "method"),
              new TypeError(r + " decorators must return a function or void 0")
            );
          }
        }
        function u(t, e, n, r, i, o, a, u, l) {
          ...
          if (
                  ...
                  0 === i || 1 === i
                    ...
                    : 3 === i
                      ...
                      : 4 === i
                        ? { set: n[3] }
                        : { value: n[3] })
              : 0 !== i && (h = Object.getOwnPropertyDescriptor(e, r)),
            1 === i
              ? (d = { get: h.get, set: h.set })
              : 2 === i
                ? (d = h.value)
                : 3 === i
                  ? (d = h.get)
            ...
            for (var b = g.length - 1; b >= 0; b--) {
              var E;
              if (void 0 !== (p = s(g[b], r, h, u, i, o, a, l, d)))
                (c(i, p),
                  0 === i
                    ? (E = p)
                    : 1 === i
          ...
          if (0 === i || 1 === i) {
            if (void 0 === f)
              ...
              var y = f;
              f = function (t, e) {
                for (var n = e, r = 0; r < y.length; r++) n = y[r].call(t, n);
                return n;
              };
            } else {
              var w = f;
          ...
          0 !== i &&
            ...
            a
              ? 1 === i
                ? (t.push(function (t, e) {
                    return d.get.call(t, e);
                  }),
                  t.push(function (t, e) {
                    return d.set.call(t, e);
                  }))
                : 2 === i
                  ? t.push(d)
                  : t.push(function (t, e) {
        ...
        return (
          (r = function (t, e, n, r) {
            if (void 0 !== r)
              var i = r[Symbol.metadata || Symbol.for("Symbol.metadata")];
            var s = Object.create(void 0 === i ? null : i),
              a = (function (t, e, n) {
                for (
                  var r, i, o = [], s = new Map(), a = new Map(), c = 0;
                  c < e.length;
                  c++
                ) {
                  var h = e[c];
                  if (Array.isArray(h)) {
                    ...
                    if (
                      ...
                      !E && p > 2 ? b.set(m, p) : b.set(m, !0);
                    }
                    u(o, f, h, m, p, g, v, d, n);
                  }
                }
                return (l(o, r), l(o, i), o);
              })(t, e, s);
            return (
              n.length || h(t, s),
              {
                ...
                get c() {
                  return (function (t, e, n) {
                    if (e.length > 0) {
                      for (
                        var r = [], i = t, s = t.name, a = e.length - 1;
                        a >= 0;
                        a--
                      ) {
                        var u = { v: !1 };
                      ...
                      return [
                        h(i, n),
                        function () {
                          for (var t = 0; t < r.length; t++) r[t].call(i);
                        },
                      ];
                    }
                  })(t, n, s);
      ...
      !(function (i, o, s) {
        ...
        function d(t, e, n) {
                  ...
                  : null == t
                    ? (function () {
                        try {
                          ...
                          var e = i.navigator,
                            n = e && e.plugins;
                          return [+new Date(), i, n, i.screen, b(o)];
                        }
                      })()
                    : t,
                3,
          ...
          return (
            ...
            )(E, f, "global" in e ? e.global : this == s, e.state)
          );
        }
        function p(t) {
          var e,
    ...
    699321: (t, e, n) => {
      "use strict";
      n.d(e, { A: () => r });
      const r = n(978109).createContext(null);
    },
    699750: (t, e, n) => {
      "use strict";
      n.d(e, { A: () => f });
      var r = n(897010),
        ...
        h = (function (t) {
          ...
          return (
            ...
            (n.render = function () {
              var t = this.props,
                e = (t.classNames, (0, i.A)(t, ["classNames"]));
    ...
    714648: (t, e, n) => {
      ...
      function a(t, e, n, u) {
        return (
          (0, o.T)(n) && ((u = n), (n = void 0)),
          u
            ? a(t, e, n).pipe(
                (0, s.T)(function (t) {
                  return (0, i.c)(t) ? u.apply(void 0, t) : u(t);
                }),
              )
            : new r.c(function (r) {
                c(
      ...
      function c(t, e, n, r, i) {
        ...
        if (
          ...
          for (var l = 0, h = t.length; l < h; l++) c(t[l], e, n, r, i);
        }
        r.add(o);
      }
    },
    717744: (t, e, n) => {
      ...
      function a() {
        ...
        return (
          ...
          null === a && 1 === t.length && t[0] instanceof r.c
            ? t[0]
            : (0, o.U)(n)((0, s.c)(t, a))
        );
      }
    ...
    740378: (t, e, n) => {
      ...
      const i = (t = !1) => {
        ...
        let i = t;
        return () => ({
          s: (t) => (i || ((i = !0), (r.eL.value = e)), t),
          r: (t) => (i && (e = r.eL.value), (i = !1), (r.eL.value = n), t),
        });
      };
    },
    742061: (t, e, n) => {
          ...
          return (
            ...
            (e.prototype.connect = function () {
              ...
              return (
                t ||
                  ((this._isComplete = !1),
                  (t = this._connection = new a.y()).add(
                    this.source.subscribe(new h(this.getSubject(), this)),
                  ),
                  t.closed && ((this._connection = null), (t = a.y.EMPTY))),
                t
              );
            }),
    ...
    821046: (t, e, n) => {
      ...
      function s(t) {
        ...
        const s = (0, o.sb)(t),
          a = s ? t.offsetWidth : n,
          c = s ? t.offsetHeight : i,
          u = (0, r.LI)(n) !== a || (0, r.LI)(i) !== c;
        return (u && ((n = a), (i = c)), { width: n, height: i, $: u });
      }
      function a(t) {
      ...
      function c(t) {
        const e = a(t);
        if (!(0, o.sb)(e)) return (0, r.Jx)(1);
        const n = e.getBoundingClientRect(),
          { width: i, height: c, $: u } = s(e);
        let l = (u ? (0, r.LI)(n.width) : n.width) / i,
          h = (u ? (0, r.LI)(n.height) : n.height) / c;
        return (
      ...
      function l(t) {
        const e = (0, o.zk)(t);
        return (0, o.Tc)() && e.visualViewport
      ...
      function h(t, e, n, i) {
        ...
        const f = (function (t, e, n) {
          ...
          ? l(u)
          : (0, r.Jx)(0);
        let d = (s.left + f.x) / h.x,
          p = (s.top + f.y) / h.y,
          m = s.width / h.x,
          v = s.height / h.y;
        if (u) {
          const t = (0, o.zk)(u),
            e = i && (0, o.vq)(i) ? (0, o.zk)(i) : i;
          let n = t,
            r = n.frameElement;
          for (; r && i && e !== n; ) {
            const t = c(r),
              ...
              i = (0, o.L9)(r),
              s = e.left + (r.clientLeft + parseFloat(i.paddingLeft)) * t.x,
              a = e.top + (r.clientTop + parseFloat(i.paddingTop)) * t.y;
            ((d *= t.x),
              (p *= t.y),
              (m *= t.x),
              (v *= t.y),
        ...
        return (0, r.B1)({ width: m, height: v, x: d, y: p });
      }
      ...
      function p(t) {
        return h((0, o.ep)(t)).left + (0, o.CP)(t).scrollLeft;
      }
      function m(t, e, n) {
        let i;
        if ("viewport" === e)
          ...
          i = (function (t) {
            ...
            const u = -n.scrollTop;
            return (
              "rtl" === (0, o.L9)(i).direction &&
                (c += (0, r.T9)(e.clientWidth, i.clientWidth) - s),
              { width: s, height: a, x: c, y: u }
            );
          })((0, o.ep)(t));
        else if ((0, o.vq)(e))
          i = (function (t, e) {
      ...
      function v(t, e) {
        const n = (0, o.$4)(t);
        return (
          !(n === e || !(0, o.vq)(n) || (0, o.eu)(n)) &&
          ("fixed" === (0, o.L9)(n).position || v(n, e))
        );
      }
      function g(t, e, n) {
        const i = (0, o.sb)(e),
        ...
        if (i || (!i && !a))
          if (
            (("body" !== (0, o.mq)(e) || (0, o.ZU)(s)) && (u = (0, o.CP)(e)), i)
          ) {
            const t = h(e, !0, a, e);
      ...
      function E(t, e) {
        return (0, o.sb)(t) && "fixed" !== (0, o.L9)(t).position
          ? e
            ? e(t)
            : t.offsetParent
          : null;
      ...
      function y(t, e) {
        ...
        if (!(0, o.sb)(t)) {
          let e = (0, o.$4)(t);
          for (; e && !(0, o.eu)(e); ) {
            if ((0, o.vq)(e) && !b(e)) return e;
            e = (0, o.$4)(e);
          }
          return n;
        }
        let r = E(t, e);
        for (; r && (0, o.Lv)(r) && b(r); ) r = E(r, e);
        return r && (0, o.eu)(r) && b(r) && !(0, o.sQ)(r)
          ? n
          : r || (0, o.gJ)(t) || n;
      }
      const w = {
        convertOffsetParentRelativeRectToViewportRelativeRect: function (t) {
          let { elements: e, rect: n, offsetParent: i, strategy: s } = t;
          const a = "fixed" === s,
            u = (0, o.ep)(i),
            l = !!e && d(e.floating);
          if (i === u || (l && a)) return n;
          ...
          if (
            (v || (!v && !a)) &&
            (("body" !== (0, o.mq)(i) || (0, o.ZU)(u)) && (f = (0, o.CP)(i)),
            (0, o.sb)(i))
          ) {
            const t = h(i);
            ((p = c(i)), (m.x = t.x + i.clientLeft), (m.y = t.y + i.clientTop));
          }
          return {
            width: n.width * p.x,
            height: n.height * p.y,
            x: n.x * p.x - f.scrollLeft * p.x + m.x,
            y: n.y * p.y - f.scrollTop * p.y + m.y,
          };
        },
              ...
              ...("clippingAncestors" === n
                ? d(e)
                  ...
                  : (function (t, e) {
                      const n = e.get(t);
                      if (n) return n;
                      let r = (0, o.v9)(t, [], !1).filter(
                          (t) => (0, o.vq)(t) && "body" !== (0, o.mq)(t),
                        ),
                        i = null;
                      const s = "fixed" === (0, o.L9)(t).position;
                      let a = s ? (0, o.$4)(t) : t;
                      for (; (0, o.vq)(a) && !(0, o.eu)(a); ) {
                        const e = (0, o.L9)(a),
                          n = (0, o.sQ)(a);
        ...
        getElementRects: async function (t) {
          ...
          return {
            reference: g(t.reference, await e(t.floating), t.strategy),
                  ...
                  (function o(c, u) {
                    ...
                    const p = {
                      rootMargin:
                        -(0, r.RI)(h) +
                        "px " +
                        -(0, r.RI)(s.clientWidth - (l + f)) +
                        "px " +
                        -(0, r.RI)(s.clientHeight - (h + d)) +
                        "px " +
                        -(0, r.RI)(l) +
                        "px",
                    ...
                    try {
                      ...
                      i = new IntersectionObserver(v, p);
                    }
                    i.observe(t);
                  })(!0),
                  a
      ...
      const _ = i.__,
        ...
        L = (t, e, n) => {
          const r = new Map(),
            o = { platform: w, ...n },
            s = { ...o.platform, _c: r };
          return (0, i.rD)(t, e, { ...o, platform: s });
        };
    },
    836932: (t, e, n) => {
      "use strict";
            ...
            return (
              (0, i.T)(n)
                ...
                : n &&
                  ...
                  n !== o.I &&
                    ((u = Object.create(n)),
                    (0, i.T)(u.unsubscribe) && c.add(u.unsubscribe.bind(u)),
        ...
        var s = i(t.children),
          a = (function (t, e) {
            ...
            var r,
              ...
              o = [];
            for (var s in t)
              s in e ? o.length && ((i[s] = o), (o = [])) : o.push(s);
            var a = {};
            for (var c in e) {
              if (i[c])
          ...
          Object.keys(a).forEach(function (i) {
            ...
            if ((0, r.isValidElement)(c)) {
              var u = i in e,
                l = i in s,
                h = e[i],
                f = (0, r.isValidElement)(h) && !h.props.in;
              !l || (u && !f)
                ? l || !u || f
                  ? l &&
                    u &&
                    (0, r.isValidElement)(h) &&
                    (a[i] = (0, r.cloneElement)(c, {
                      onExited: n.bind(null, c),
                      in: h.props.in,
                      exit: o(c, "exit", t),
                      enter: o(c, "enter", t),
                    }))
                  : (a[i] = (0, r.cloneElement)(c, { in: !1 }))
                : (a[i] = (0, r.cloneElement)(c, {
                    onExited: n.bind(null, c),
                    in: !0,
                    exit: o(c, "exit", t),
    ...
    853469: (t, e, n) => {
      ...
      function a(t, e, n, c, u, l, h) {
        if (1 === t.length && (0, i.eW)(t[0]))
          return [{ type: r.literal, value: t[0].value }];
        for (var f = [], d = 0, p = t; d < p.length; d++) {
          var m = p[d];
          if ((0, i.eW)(m)) f.push({ type: r.literal, value: m.value });
          else if ((0, i.jA)(m))
            "number" == typeof l &&
              f.push({
                type: r.literal,
            ...
            var v = m.value;
            if (!u || !(v in u)) throw new o.Ei(v, h);
            var g = u[v];
            if ((0, i.Im)(m))
              ...
              f.push({
                type: r.literal,
                value: n.getDateTimeFormat(e, b).format(g),
              });
            } else if ((0, i.Qh)(m)) {
              b =
                "string" == typeof m.style
              ...
              ((b =
                ...
                f.push({
                  type: r.literal,
                  value: n.getNumberFormat(e, b).format(g),
                }));
            } else {
              if ((0, i.xm)(m)) {
                var E = m.children,
                  y = m.value,
                  w = u[y];
                if (!s(w)) throw new o.Zo(y, "function", h);
                var T = w(
                  a(E, e, n, c, u, l).map(function (t) {
                    return t.value;
                  }),
                );
                (Array.isArray(T) || (T = [T]),
              ...
              if ((0, i.Jp)(m)) {
                if (!(_ = m.options[g] || m.options.other))
                  throw new o.$x(m.value, g, Object.keys(m.options), h);
                f.push.apply(f, a(_.value, e, n, c, u));
              } else if ((0, i.N6)(m)) {
                var _;
                if (!(_ = m.options["=".concat(g)])) {
                  if (!Intl.PluralRules)
                    throw new o.IF(
                  ...
                  var A = n
                    ...
                    .select(g - (m.offset || 0));
                  _ = m.options[A] || m.options.other;
                }
                if (!_) throw new o.$x(m.value, g, Object.keys(m.options), h);
                f.push.apply(f, a(_.value, e, n, c, u, g - (m.offset || 0)));
              } else;
            }
          }
        }
    ...
    984543: (t, e, n) => {
      "use strict";
      n.d(e, { Fm: () => o, eL: () => i, rT: () => s });
      const r = Symbol("Snapshot.wrapped"),
        i = { value: void 0 };
      class o {
        constructor() {
          (null != i.value && (this.parentSnapshot = i.value),
        ...
        static wrap(t) {
          if ("function" != typeof t || t[r]) return t;
          const e = i.value,
            n = function (...n) {
              const r = i.value;
              i.value = e;
      ...
      class s {
        constructor(t) {
          ((this.snapshotToValue = new WeakMap()),
            (this.name = t?.name || ""),
        ...
        get() {
          let t = i.value;
          for (; null != t; ) {
            if (this.snapshotToValue.has(t)) return this.snapshotToValue.get(t);
            t = t.parentSnapshot;
          }
        ...
        run(t, e, ...n) {
          const r = new o();
          return (this.snapshotToValue.set(r, t), r.run(e, ...n));
        }
      }
      i.value = new o();
    },
...
//# sourceMappingURL=sourcemaps/0fb5f701f46ae649.vendor.js.map
